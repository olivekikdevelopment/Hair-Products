...
.field protected c:Lkik/android/util/ao;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.method static synthetic a(Lkik/android/chat/fragment/MissedConversationsFragment;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    ...
    .line 388
    iget-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->c:Lkik/android/util/ao;
...
.method onClearButtonClicked()V
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/fp;->a(Lkik/android/chat/fragment/MissedConversationsFragment;)Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/fq;->a(Lkik/android/chat/fragment/MissedConversationsFragment;)Landroid/content/DialogInterface$OnClickListener;
...
.method onConversationListClicked(I)V
    ...
    invoke-virtual {p1}, Lkik/android/chat/fragment/KikChatFragment$a;->d()Lkik/android/chat/fragment/KikChatFragment$a;

    move-result-object p1

    .line 2294
    invoke-virtual {p0, p1}, Lkik/android/chat/fragment/MissedConversationsFragment;->startFragmentForResult(Lkik/android/util/aj;)Lcom/kik/events/Promise;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/ft;->a(Lkik/android/chat/fragment/MissedConversationsFragment;)Lcom/kik/events/p;
...
.method onMuteButtonClicked()V
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/fr;->a(Lkik/android/chat/fragment/MissedConversationsFragment;)Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/fs;->a(Lkik/android/chat/fragment/MissedConversationsFragment;)Landroid/content/DialogInterface$OnClickListener;
...
.method public updateConvoList(Z)V
    ...
    .line 263
    invoke-virtual {v0}, Lkik/android/chat/vm/m;->g()I
    ...
    .line 266
    new-instance v2, Lcom/kik/view/adapters/q;
    ...
    invoke-direct {v2, v4}, Lcom/kik/view/adapters/q;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->i:Lcom/kik/view/adapters/q;
    ...
    invoke-virtual {p0}, Lkik/android/chat/fragment/MissedConversationsFragment;->getNavigator()Lkik/android/chat/vm/bm;

    move-result-object v6

    invoke-direct {v2, v4, v0, v5, v6}, Lcom/kik/view/adapters/j;-><init>(Landroid/content/Context;Lkik/android/chat/vm/m;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    iput-object v2, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->g:Lcom/kik/view/adapters/j;
    ...
    invoke-direct {v0, v2, v1, v4, v5}, Lcom/kik/view/adapters/j;-><init>(Landroid/content/Context;Lkik/android/chat/vm/m;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    iput-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->h:Lcom/kik/view/adapters/j;

    .line 269
    iget-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->i:Lcom/kik/view/adapters/q;

    iget-object v1, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->g:Lcom/kik/view/adapters/j;

    invoke-virtual {v0, v1}, Lcom/kik/view/adapters/q;->a(Landroid/widget/Adapter;)V

    .line 270
    iget-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->i:Lcom/kik/view/adapters/q;

    iget-object v1, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->h:Lcom/kik/view/adapters/j;

    invoke-virtual {v0, v1}, Lcom/kik/view/adapters/q;->b(Landroid/widget/Adapter;)V
    ...
    iget-object v1, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->i:Lcom/kik/view/adapters/q;
    ...
    invoke-static {v0}, Lcom/kik/util/dj;->a(Landroid/widget/ListView;)V

    goto :goto_2

    .line 276
    :cond_3
    iget-object v2, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->g:Lcom/kik/view/adapters/j;

    invoke-virtual {v2, v0}, Lcom/kik/view/adapters/j;->a(Lkik/android/chat/vm/IListViewModel;)V

    .line 277
    iget-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->h:Lcom/kik/view/adapters/j;

    invoke-virtual {v0, v1}, Lcom/kik/view/adapters/j;->a(Lkik/android/chat/vm/IListViewModel;)V

    .line 278
    iget-object v0, p0, Lkik/android/chat/fragment/MissedConversationsFragment;->g:Lcom/kik/view/adapters/j;
