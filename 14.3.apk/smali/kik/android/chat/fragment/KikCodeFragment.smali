...
.field protected f:Lkik/core/interfaces/ah;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field private final s:Lkik/android/util/ck;
...
.field private final w:Lkik/android/chat/fragment/KikCodeFragment$c;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0}, Lkik/android/util/ck;-><init>()V

    iput-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->s:Lkik/android/util/ck;
    ...
    iput-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->v:Landroid/view/View$OnTouchListener;
    ...
    iput-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->w:Lkik/android/chat/fragment/KikCodeFragment$c;
...
.method private a(Lcom/kik/scan/KikCode;)V
    ...
    .line 278
    new-instance p1, Lkik/android/chat/fragment/KikCodeFragment$13;

    invoke-direct {p1, p0}, Lkik/android/chat/fragment/KikCodeFragment$13;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V

    invoke-virtual {p0, p1}, Lkik/android/chat/fragment/KikCodeFragment;->runOnUiIfAttached(Ljava/lang/Runnable;)V
...
.method static synthetic a(Lkik/android/chat/fragment/KikCodeFragment;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lkik/android/chat/fragment/KikCodeFragment;->runOnUiIfAttached(Ljava/lang/Runnable;)V
...
.method static synthetic a(Lkik/android/chat/fragment/KikCodeFragment;Lkik/android/chat/fragment/KikCodeFragment$c;)V
    ...
    .line 7765
    new-instance p1, Lkik/android/chat/fragment/KikCodeFragment$9;

    invoke-direct {p1, p0}, Lkik/android/chat/fragment/KikCodeFragment$9;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V
...
.method static synthetic a(Lkik/android/chat/fragment/KikCodeFragment;Lkik/core/datatypes/q;)V
    .locals 0

    .line 73
    invoke-direct {p0, p1}, Lkik/android/chat/fragment/KikCodeFragment;->a(Lkik/core/datatypes/q;)V
...
.method private a(Lkik/core/datatypes/q;)V
    ...
    iget-object v1, p0, Lkik/android/chat/fragment/KikCodeFragment;->a:Lcom/kik/cache/KikVolleyImageLoader;

    iget-object v2, p0, Lkik/android/chat/fragment/KikCodeFragment;->e:Lkik/core/interfaces/w;

    iget-object v3, p0, Lkik/android/chat/fragment/KikCodeFragment;->g:Lcom/kik/android/Mixpanel;

    invoke-virtual {v0, p1, v1, v2, v3}, Lcom/kik/cache/ContactImageView;->a(Lkik/core/datatypes/m;Lcom/kik/cache/KikVolleyImageLoader;Lkik/core/interfaces/w;Lcom/kik/android/Mixpanel;)V
    ...
    invoke-direct {v1, p0, p1}, Lkik/android/chat/fragment/KikCodeFragment$17;-><init>(Lkik/android/chat/fragment/KikCodeFragment;Lkik/core/datatypes/q;)V
    ...
    iget-object v1, p0, Lkik/android/chat/fragment/KikCodeFragment;->e:Lkik/core/interfaces/w;

    invoke-static {v0, v1}, Lkik/android/util/cg;->a(Ljava/util/List;Lkik/core/interfaces/w;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V
    ...
    invoke-static {v0, p1}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V
...
.method static synthetic b(Lkik/android/chat/fragment/KikCodeFragment;)Lkik/android/util/ck;
    .locals 0

    .line 73
    iget-object p0, p0, Lkik/android/chat/fragment/KikCodeFragment;->s:Lkik/android/util/ck;
...
.method static synthetic b(Lkik/android/chat/fragment/KikCodeFragment;Lkik/core/datatypes/q;)V
    .locals 0

    .line 73
    invoke-direct {p0, p1}, Lkik/android/chat/fragment/KikCodeFragment;->b(Lkik/core/datatypes/q;)V
...
.method private b(Lkik/core/datatypes/q;)V
    ...
    .line 397
    invoke-virtual {p0}, Lkik/android/chat/fragment/KikCodeFragment;->getLifecycleEventHub()Lcom/kik/events/d;

    move-result-object v0

    iget-object v1, p0, Lkik/android/chat/fragment/KikCodeFragment;->j:Lkik/core/interfaces/l;
    ...
    invoke-direct {v2, p0, p1}, Lkik/android/chat/fragment/KikCodeFragment$18;-><init>(Lkik/android/chat/fragment/KikCodeFragment;Lkik/core/datatypes/q;)V
    ...
    invoke-static {v0, v1}, Lkik/core/net/outgoing/GetGroupKikCodeRequest;->GetGroupKikCodeRequest(Lkik/core/net/d;Ljava/lang/String;)Lkik/core/net/outgoing/GetGroupKikCodeRequest;

    move-result-object v0

    .line 416
    iget-object v1, p0, Lkik/android/chat/fragment/KikCodeFragment;->_comm:Lkik/core/interfaces/ICommunication;
    ...
    invoke-direct {v1, p0, p1}, Lkik/android/chat/fragment/KikCodeFragment$2;-><init>(Lkik/android/chat/fragment/KikCodeFragment;Lkik/core/datatypes/q;)V
...
.method static synthetic g(Lkik/android/chat/fragment/KikCodeFragment;)V
    ...
    invoke-static {v4, v1}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V
    ...
    new-instance v2, Lkik/android/chat/fragment/KikCodeFragment$4;

    invoke-direct {v2, p0}, Lkik/android/chat/fragment/KikCodeFragment$4;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V
    ...
    iget-object v2, p0, Lkik/android/chat/fragment/KikCodeFragment;->v:Landroid/view/View$OnTouchListener;
    ...
    invoke-virtual {p0}, Lkik/android/util/ck;->a()Landroid/graphics/Point;
    ...
    invoke-direct {v2, p0, v0}, Lkik/android/chat/fragment/KikCodeFragment$5;-><init>(Lkik/android/chat/fragment/KikCodeFragment;I)V
...
.method static synthetic h(Lkik/android/chat/fragment/KikCodeFragment;)V
    ...
    .line 73
    invoke-direct {p0}, Lkik/android/chat/fragment/KikCodeFragment;->f()V
...
.method static synthetic j(Lkik/android/chat/fragment/KikCodeFragment;)Lkik/core/datatypes/q;
    .locals 0

    .line 73
    iget-object p0, p0, Lkik/android/chat/fragment/KikCodeFragment;->u:Lkik/core/datatypes/q;
...
.method static synthetic n(Lkik/android/chat/fragment/KikCodeFragment;)Landroid/view/View$OnTouchListener;
    ...
    .line 73
    iget-object p0, p0, Lkik/android/chat/fragment/KikCodeFragment;->v:Landroid/view/View$OnTouchListener;
...
.method static synthetic o(Lkik/android/chat/fragment/KikCodeFragment;)Lkik/android/chat/fragment/KikCodeFragment$c;
    ...
    .line 73
    iget-object p0, p0, Lkik/android/chat/fragment/KikCodeFragment;->w:Lkik/android/chat/fragment/KikCodeFragment$c;
...
.method static synthetic p(Lkik/android/chat/fragment/KikCodeFragment;)V
    ...
    .line 7783
    :cond_0
    invoke-direct {p0}, Lkik/android/chat/fragment/KikCodeFragment;->g()V
...
.method protected displayErrorDialog(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v0, Lkik/android/chat/fragment/KikCodeFragment$6;

    invoke-direct {v0, p0}, Lkik/android/chat/fragment/KikCodeFragment$6;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V
    ...
    invoke-virtual {p0, p1}, Lkik/android/chat/fragment/KikCodeFragment;->replaceDialog(Lkik/android/chat/fragment/KikDialogFragment;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 165
    invoke-virtual {p0}, Lkik/android/chat/fragment/KikCodeFragment;->getCoreComponent()Lcom/kik/components/CoreComponent;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 181
    iget-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->j:Lkik/core/interfaces/l;

    invoke-interface {v0, p1, p2}, Lkik/core/interfaces/l;->a(Ljava/lang/String;Z)Lkik/core/datatypes/q;

    move-result-object p1

    iput-object p1, p0, Lkik/android/chat/fragment/KikCodeFragment;->u:Lkik/core/datatypes/q;
    ...
    .line 1256
    iget-object p1, p0, Lkik/android/chat/fragment/KikCodeFragment;->u:Lkik/core/datatypes/q;
    ...
    iget-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->f:Lkik/core/interfaces/ah;

    invoke-interface {v0}, Lkik/core/interfaces/ah;->e()Lkik/core/datatypes/ab;

    move-result-object v0

    iget-object v0, v0, Lkik/core/datatypes/ab;->d:Ljava/lang/String;
    ...
    iget-object p3, p0, Lkik/android/chat/fragment/KikCodeFragment;->f:Lkik/core/interfaces/ah;

    invoke-interface {p3}, Lkik/core/interfaces/ah;->e()Lkik/core/datatypes/ab;

    move-result-object p3

    iget-object v0, p0, Lkik/android/chat/fragment/KikCodeFragment;->a:Lcom/kik/cache/KikVolleyImageLoader;

    iget-object v1, p0, Lkik/android/chat/fragment/KikCodeFragment;->g:Lcom/kik/android/Mixpanel;

    invoke-virtual {p2, p3, v0, v1}, Lcom/kik/cache/ContactImageView;->a(Lkik/core/datatypes/ab;Lcom/kik/cache/KikVolleyImageLoader;Lcom/kik/android/Mixpanel;)V
    ...
    iget-object p3, p3, Lkik/core/datatypes/ab;->d:Ljava/lang/String;
    ...
    iget-object p3, p3, Lkik/core/datatypes/ab;->e:Ljava/lang/String;
    ...
    invoke-static {p2, p3}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V

    .line 1456
    iget-object p2, p0, Lkik/android/chat/fragment/KikCodeFragment;->f:Lkik/core/interfaces/ah;
    ...
    invoke-static {p1, p2}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V

    .line 1459
    iget-object p1, p0, Lkik/android/chat/fragment/KikCodeFragment;->_profilePic:Lcom/kik/cache/ContactImageView;

    new-instance p2, Lkik/android/chat/fragment/KikCodeFragment$3;

    invoke-direct {p2, p0}, Lkik/android/chat/fragment/KikCodeFragment$3;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V

    invoke-virtual {p1, p2}, Lcom/kik/cache/ContactImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 186
    :goto_0
    invoke-virtual {p0}, Lkik/android/chat/fragment/KikCodeFragment;->getTransparentStatusHeight()I
    ...
    invoke-static {p2}, Lkik/android/util/cp;->a(Landroid/view/View;)Lkik/android/util/cp$b;

    move-result-object p2

    invoke-virtual {p2, p1}, Lkik/android/util/cp$b;->a(I)Lkik/android/util/cp$b;
    ...
    new-instance p2, Lkik/android/chat/fragment/KikCodeFragment$12;

    invoke-direct {p2, p0}, Lkik/android/chat/fragment/KikCodeFragment$12;-><init>(Lkik/android/chat/fragment/KikCodeFragment;)V
