...
.field private g:Lkik/android/e/bd;

.field private h:Lkik/android/chat/vm/bu;
...
.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;Lkik/android/chat/vm/bm;)Lkik/android/chat/vm/bm;
    .locals 0

    .line 23
    iput-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/bm;

    return-object p1
.end method

.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;Lkik/android/chat/vm/bu;)Lkik/android/chat/vm/bu;
    .locals 0

    .line 23
    iput-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;
...
.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;)V
    ...
    .line 55
    iget-object p0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;

    invoke-interface {p0}, Lkik/android/chat/vm/bu;->P_()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1079
    iget-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    invoke-virtual {p1}, Lkik/android/e/bd;->getRoot()Landroid/view/View;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 36
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/bm;
    ...
    .line 39
    :cond_0
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;

    invoke-virtual {p0}, Lkik/android/chat/fragment/KikGranReportDialogFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;

    move-result-object v1

    invoke-static {v1}, Lkik/android/util/v;->a(Landroid/content/Context;)Lcom/kik/components/CoreComponent;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/bm;

    invoke-interface {v0, v1, v2}, Lkik/android/chat/vm/bu;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    iput-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    .line 42
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;

    invoke-virtual {v0, v1}, Lkik/android/e/bd;->a(Lkik/android/chat/vm/bu;)V

    .line 43
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    iget-object v0, v0, Lkik/android/e/bd;->b:Lkik/android/e/ag;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;

    invoke-virtual {v0, v1}, Lkik/android/e/ag;->a(Lkik/android/chat/vm/bu;)V

    .line 44
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    iget-object v0, v0, Lkik/android/e/bd;->c:Lkik/android/e/af;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bu;

    invoke-virtual {v0, v1}, Lkik/android/e/af;->a(Lkik/android/chat/vm/bu;)V

    .line 46
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bd;

    invoke-virtual {v0}, Lkik/android/e/bd;->getRoot()Landroid/view/View;
    ...
    invoke-interface {v1}, Lkik/android/chat/vm/bu;->i()Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/fragment/cr;->a(Lkik/android/chat/fragment/KikGranReportDialogFragment;)Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-interface {v1}, Lkik/android/chat/vm/bu;->D_()Ljava/lang/String;
