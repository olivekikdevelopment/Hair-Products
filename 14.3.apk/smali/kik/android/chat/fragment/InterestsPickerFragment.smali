...
.field private b:Lkik/android/chat/vm/bc;

.field private c:Lkik/android/chat/vm/bx;
...
.method static synthetic a(Lkik/android/chat/fragment/InterestsPickerFragment;Ljava/lang/Boolean;)V
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/aa;->a(Lkik/android/chat/fragment/InterestsPickerFragment;)Landroid/content/DialogInterface$OnClickListener;
...
.method public handleBackPress()Z
    ...
    .line 74
    iget-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/bc;

    invoke-interface {v0}, Lkik/android/chat/vm/bc;->v_()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/fragment/z;->a(Lkik/android/chat/fragment/InterestsPickerFragment;)Lrx/functions/b;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1}, Lkik/android/chat/fragment/InterestsPickerFragment$a;->q_()Ljava/util/List;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    check-cast p1, Lkik/android/e/ao;

    .line 58
    invoke-virtual {p1}, Lkik/android/e/ao;->getRoot()Landroid/view/View;
    ...
    invoke-direct {v0, p3}, Lkik/android/chat/vm/cl;-><init>(Lkik/android/chat/l;)V

    iput-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/bc;

    .line 62
    iget-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/bc;

    invoke-virtual {p0, v0}, Lkik/android/chat/fragment/InterestsPickerFragment;->attachVm(Lkik/android/chat/vm/cg;)Lkik/android/chat/vm/cg;

    .line 63
    iget-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->b:Lkik/android/chat/vm/bc;

    invoke-virtual {p1, v0}, Lkik/android/e/ao;->a(Lkik/android/chat/vm/bc;)V

    .line 65
    new-instance v0, Lkik/android/chat/vm/fp;

    invoke-direct {v0, p3}, Lkik/android/chat/vm/fp;-><init>(Lkik/android/chat/l;)V

    iput-object v0, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->c:Lkik/android/chat/vm/bx;

    .line 66
    iget-object p3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->c:Lkik/android/chat/vm/bx;

    invoke-virtual {p0, p3}, Lkik/android/chat/fragment/InterestsPickerFragment;->attachVm(Lkik/android/chat/vm/cg;)Lkik/android/chat/vm/cg;

    .line 67
    iget-object p3, p0, Lkik/android/chat/fragment/InterestsPickerFragment;->c:Lkik/android/chat/vm/bx;

    invoke-virtual {p1, p3}, Lkik/android/e/ao;->a(Lkik/android/chat/vm/bx;)V
