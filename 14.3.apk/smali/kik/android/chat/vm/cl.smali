.class public final Lkik/android/chat/vm/cl;
...
.method public constructor <init>(Lkik/android/chat/l;)V
    ...
    .line 60
    iput-object p1, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;
    ...
    iput-object p1, p0, Lkik/android/chat/vm/cl;->j:Lrx/subjects/a;

    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/cl;Ljava/util/List;)Ljava/util/List;
    .locals 0

    .line 44
    iput-object p1, p0, Lkik/android/chat/vm/cl;->h:Ljava/util/List;

    return-object p1
.end method

.method static synthetic a(Lkik/android/chat/vm/cl;)V
    .locals 0

    .line 212
    invoke-virtual {p0}, Lkik/android/chat/vm/cl;->S_()Lkik/android/chat/vm/bm;
...
.method static synthetic b(Lkik/android/chat/vm/cl;)Lkik/android/chat/l;
    .locals 0

    .line 44
    iget-object p0, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;

    return-object p0
.end method

.method static synthetic c(Lkik/android/chat/vm/cl;)V
    .locals 3
    ...
    iget-object v1, p0, Lkik/android/chat/vm/cl;->a:Landroid/content/res/Resources;
...
.method static synthetic d(Lkik/android/chat/vm/cl;)Lrx/subjects/a;
    .locals 0

    .line 44
    iget-object p0, p0, Lkik/android/chat/vm/cl;->j:Lrx/subjects/a;

    return-object p0
.end method

.method static synthetic e(Lkik/android/chat/vm/cl;)V
    .locals 3
    ...
    invoke-static {p0}, Lkik/android/chat/vm/cm;->a(Lkik/android/chat/vm/cl;)Ljava/lang/Runnable;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/cn;->a(Lkik/android/chat/vm/cl;)Ljava/lang/Runnable;
...
.method static synthetic f(Lkik/android/chat/vm/cl;)V
    .locals 0

    invoke-direct {p0}, Lkik/android/chat/vm/cl;->j()V
...
.method private j()V
    ...
    .line 231
    iget-object v0, p0, Lkik/android/chat/vm/cl;->j:Lrx/subjects/a;
    ...
    .line 232
    iget-object v0, p0, Lkik/android/chat/vm/cl;->f:Ldagger/a;
    ...
    new-instance v1, Lkik/android/chat/vm/cl$3;

    invoke-direct {v1, p0}, Lkik/android/chat/vm/cl$3;-><init>(Lkik/android/chat/vm/cl;)V
...
.method protected final synthetic a(I)Lkik/android/chat/vm/bh;
    ...
    .line 4075
    iget-object v0, p0, Lkik/android/chat/vm/cl;->h:Ljava/util/List;
    ...
    iget-object v1, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;

    invoke-virtual {v1}, Lkik/android/chat/l;->b()Lrx/d;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;
    ...
    invoke-direct {v0, p1, v1, v2, p0}, Lkik/android/chat/vm/fm;-><init>(Lkik/core/chat/profile/bd;Lrx/d;ZLkik/core/interfaces/p;)V
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 67
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/cl;)V

    .line 68
    invoke-super {p0, p1, p2}, Lkik/android/chat/vm/c;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    .line 1219
    iget-object p1, p0, Lkik/android/chat/vm/cl;->e:Ldagger/a;
    ...
    .line 1221
    iget-object p1, p0, Lkik/android/chat/vm/cl;->h:Ljava/util/List;
    ...
    .line 1225
    :cond_0
    iget-object p1, p0, Lkik/android/chat/vm/cl;->j:Lrx/subjects/a;
...
.method public final a(Lkik/core/chat/profile/bd;)Z
    ...
    .line 170
    iget-object v0, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;
    ...
    iget-object v0, p0, Lkik/android/chat/vm/cl;->a:Landroid/content/res/Resources;
...
.method public final w_()V
    ...
    .line 2105
    iget-object v0, p0, Lkik/android/chat/vm/cl;->b:Lkik/core/chat/profile/IContactProfileRepository;

    iget-object v1, p0, Lkik/android/chat/vm/cl;->d:Lkik/core/interfaces/ad;
    ...
    iget-object v3, p0, Lkik/android/chat/vm/cl;->i:Lkik/android/chat/l;
    ...
    new-instance v2, Lkik/android/chat/vm/cl$1;

    invoke-direct {v2, p0}, Lkik/android/chat/vm/cl$1;-><init>(Lkik/android/chat/vm/cl;)V
    ...
    new-instance v1, Lkik/android/chat/vm/cl$2;

    invoke-direct {v1, p0}, Lkik/android/chat/vm/cl$2;-><init>(Lkik/android/chat/vm/cl;)V
...
.method public final x_()V
    ...
    new-instance v1, Lkik/android/chat/vm/cc;

    invoke-direct {v1}, Lkik/android/chat/vm/cc;-><init>()V

    invoke-interface {v0}, Lkik/android/chat/vm/bm;->l()V
