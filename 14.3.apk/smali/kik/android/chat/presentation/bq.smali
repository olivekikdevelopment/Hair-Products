...
.implements Lkik/android/chat/view/ae$a;
...
# instance fields
.field private a:Lkik/android/chat/view/ae;
...
.method static synthetic a(Lkik/android/chat/presentation/bq;)Lkik/android/chat/presentation/r;
    ...
    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->e:Lkik/android/chat/presentation/r;
...
.method private a(J)V
    ...
    .line 330
    iget-object v1, p0, Lkik/android/chat/presentation/bq;->k:Ljava/util/Timer;

    new-instance v2, Lkik/android/chat/presentation/bq$b;

    iget-object v0, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    iget-object v3, p0, Lkik/android/chat/presentation/bq;->b:Lkik/android/challenge/PhoneVerificationNetworkProvider;

    invoke-direct {v2, v0, v3}, Lkik/android/chat/presentation/bq$b;-><init>(Lkik/android/chat/view/ae;Lkik/android/challenge/PhoneVerificationNetworkProvider;)V
...
.method static synthetic b(Lkik/android/chat/presentation/bq;)Lkik/android/challenge/PhoneNumberModel;
    ...
    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->f:Lkik/android/challenge/PhoneNumberModel;
...
.method static synthetic c(Lkik/android/chat/presentation/bq;)Lkik/android/chat/presentation/bp$a;
    ...
    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->d:Lkik/android/chat/presentation/bp$a;
...
.method static synthetic d(Lkik/android/chat/presentation/bq;)Lkik/android/chat/view/ae;
    .locals 0

    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;
...
.method static synthetic f(Lkik/android/chat/presentation/bq;)Lkik/android/challenge/PhoneVerificationNetworkProvider;
    ...
    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->b:Lkik/android/challenge/PhoneVerificationNetworkProvider;
...
.method static synthetic g(Lkik/android/chat/presentation/bq;)Landroid/content/Context;
    ...
    .line 35
    iget-object p0, p0, Lkik/android/chat/presentation/bq;->i:Landroid/content/Context;
...
.method public final synthetic a(Ljava/lang/Object;)V
    ...
    .line 35
    check-cast p1, Lkik/android/chat/view/ae;
    ...
    .line 2130
    :cond_0
    iput-object p1, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    .line 2131
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    invoke-interface {p1, p0}, Lkik/android/chat/view/ae;->a(Lkik/android/chat/view/ae$a;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-interface {v0}, Lkik/android/chat/view/ae;->a()V
    ...
    .line 171
    iget-object v1, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    invoke-interface {v1, v0}, Lkik/android/chat/view/ae;->b(Ljava/lang/String;)V
    ...
    .line 176
    :cond_2
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->j:Ljava/util/Timer;

    new-instance v0, Lkik/android/chat/presentation/bq$a;

    iget-object v1, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    invoke-direct {v0, v1}, Lkik/android/chat/presentation/bq$a;-><init>(Lkik/android/chat/view/ae;)V
...
.method public final a(Ljava/lang/String;Lkik/android/challenge/PhoneNumberModel;Lkik/android/util/KeyboardManipulator;Lkik/android/challenge/PhoneVerificationNetworkProvider;Lkik/android/chat/presentation/bp$a;Lkik/android/chat/presentation/r;Landroid/content/Context;)V
    ...
    .line 1299
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->b:Lkik/android/challenge/PhoneVerificationNetworkProvider;
    ...
    .line 1300
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->f:Lkik/android/challenge/PhoneNumberModel;
    ...
    .line 1303
    iget-object p2, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    invoke-interface {p2, p1}, Lkik/android/chat/view/ae;->a(Ljava/lang/String;)V

    .line 1306
    :cond_0
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;

    iget-object p2, p0, Lkik/android/chat/presentation/bq;->h:Ljava/lang/String;

    invoke-interface {p1, p2}, Lkik/android/chat/view/ae;->b(Ljava/lang/String;)V

    .line 1307
    iget-object p1, p0, Lkik/android/chat/presentation/bq;->c:Lkik/android/util/KeyboardManipulator;

    if-eqz p1, :cond_1

    iget-object p1, p0, Lkik/android/chat/presentation/bq;->h:Ljava/lang/String;
    ...
    iget-object p2, p0, Lkik/android/chat/presentation/bq;->c:Lkik/android/util/KeyboardManipulator;

    invoke-interface {p1, p2}, Lkik/android/chat/view/ae;->a(Lkik/android/util/KeyboardManipulator;)V

    :cond_1
    const-wide/16 p1, 0x0

    .line 1310
    invoke-direct {p0, p1, p2}, Lkik/android/chat/presentation/bq;->a(J)V
...
.method public final t_()V
    ...
    .line 137
    iput-object v0, p0, Lkik/android/chat/presentation/bq;->a:Lkik/android/chat/view/ae;
