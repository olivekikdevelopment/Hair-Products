...
.field public static zzhra:I = 0x4c4b40

.field private static zzhrb:I = 0x632ea0

.field private static zzhrc:I = 0x6acfc0

.field private static zzhrd:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

.field private static final zzhrg:Ljava/util/concurrent/atomic/AtomicInteger;
...
.field private zzhrf:Ljava/util/Map;
...
.field private final zzhrh:Ljava/util/concurrent/BlockingQueue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrg:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrf:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {v0}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrh:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/android/gms/gcm/c;-><init>(Lcom/google/android/gms/gcm/GoogleCloudMessaging;Landroid/os/Looper;)V

    invoke-direct {v0, v1}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhri:Landroid/os/Messenger;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrd:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrd:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    iput-object p0, v1, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;

    :cond_0
    sget-object p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrd:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    :try_end_0
...
.method private final zza(Landroid/os/Bundle;Z)Landroid/content/Intent;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;

    invoke-static {v1}, Lcom/google/android/gms/iid/zze;->zzdg(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    invoke-direct {p0, v0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzf(Landroid/content/Intent;)V
    ...
    sget-object v2, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrg:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhri:Landroid/os/Messenger;

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    if-eqz p2, :cond_4

    iget-object p1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;
    ...
    :goto_2
    :try_start_0
    iget-object p1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrh:Ljava/util/concurrent/BlockingQueue;
...
.method private final varargs declared-synchronized zza(Z[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zza(Landroid/os/Bundle;Z)Landroid/content/Intent;
...
.method static synthetic zza(Lcom/google/android/gms/gcm/GoogleCloudMessaging;)Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object p0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrh:Ljava/util/concurrent/BlockingQueue;
...
.method private final declared-synchronized zzasi()V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhre:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhre:Landroid/app/PendingIntent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static synthetic zzb(Lcom/google/android/gms/gcm/GoogleCloudMessaging;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;
...
.method private final zze(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrf:Ljava/util/Map;
...
.method private final declared-synchronized zzf(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhre:Landroid/app/PendingIntent;
...
.method public close()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzhrd:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    sput-object v0, Lcom/google/android/gms/gcm/a;->a:Lcom/google/android/gms/gcm/a;

    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzasi()V
...
.method public varargs declared-synchronized register([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/iid/zze;->zzdf(Landroid/content/Context;)Z
...
.method public send(Ljava/lang/String;Ljava/lang/String;JLandroid/os/Bundle;)V
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzaie:Landroid/content/Context;
    ...
    invoke-virtual {v2, v3, p4, v4}, Lcom/google/android/gms/iid/zzh;->zze(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p2, p4, p3}, Lcom/google/android/gms/iid/InstanceID;->zzb(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
