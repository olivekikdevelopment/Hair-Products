...
.method public static getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GcmNetworkManager;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzhqe:Lcom/google/android/gms/gcm/GcmNetworkManager;
    ...
    sput-object v1, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzhqe:Lcom/google/android/gms/gcm/GcmNetworkManager;

    :cond_0
    sget-object p0, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzhqe:Lcom/google/android/gms/gcm/GcmNetworkManager;
...
.method private static zza(Landroid/content/pm/PackageManager;Landroid/content/Intent;I)Ljava/util/List;
    ...
    const-string p0, "validation query succeeded on try #2"
...
.method private final zzase()Landroid/content/Intent;
    ...
    invoke-static {v1}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzdc(Landroid/content/Context;)I
...
.method private final zzho(Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v4, p0, Lcom/google/android/gms/gcm/GcmNetworkManager;->mContext:Landroid/content/Context;
    ...
    const-string v4, " because user is shutting down"
    ...
    invoke-virtual {v1, v4, p1}, Landroid/content/Intent;->setClassName(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    :goto_5
    invoke-static {v0, v1, v2}, Lcom/google/android/gms/gcm/GcmNetworkManager;->zza(Landroid/content/pm/PackageManager;Landroid/content/Intent;I)Ljava/util/List;
...
.method public cancelAllTasks(Ljava/lang/Class;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzho(Ljava/lang/String;)Z
...
.method public cancelTask(Ljava/lang/String;Ljava/lang/Class;)V
    ...
    invoke-direct {p0, p2}, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzho(Ljava/lang/String;)Z
...
.method final declared-synchronized zzad(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzhqg:Ljava/util/Map;
...
.method final declared-synchronized zzae(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/gcm/GcmNetworkManager;->zzhqg:Ljava/util/Map;
