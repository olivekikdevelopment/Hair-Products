...
.method public final release()V
    ...
    invoke-virtual {v4, v5}, Lcom/google/android/gms/common/api/internal/zzs;->zza(Lcom/google/android/gms/common/api/internal/ap;)V

    invoke-virtual {v4}, Lcom/google/android/gms/common/api/PendingResult;->zzafr()Ljava/lang/Integer;

    move-result-object v6

    if-nez v6, :cond_0

    invoke-virtual {v4}, Lcom/google/android/gms/common/api/internal/zzs;->zzage()Z
    ...
    :goto_1
    iget-object v5, p0, Lcom/google/android/gms/common/api/internal/zzdi;->zzfpm:Ljava/util/Set;
    ...
    invoke-virtual {v7}, Lcom/google/android/gms/common/api/internal/zzm;->zzafd()Lcom/google/android/gms/common/api/Api$zzc;
    ...
    invoke-interface {v6}, Lcom/google/android/gms/common/api/Api$zze;->zzaff()Landroid/os/IBinder;

    move-result-object v6

    invoke-virtual {v4}, Lcom/google/android/gms/common/api/internal/zzs;->isReady()Z

    move-result v7

    if-eqz v7, :cond_1

    new-instance v5, Lcom/google/android/gms/common/api/internal/ao;

    invoke-direct {v5, v4, v6, v2}, Lcom/google/android/gms/common/api/internal/ao;-><init>(Lcom/google/android/gms/common/api/internal/zzs;Landroid/os/IBinder;B)V
    ...
    new-instance v7, Lcom/google/android/gms/common/api/internal/ao;

    invoke-direct {v7, v4, v6, v2}, Lcom/google/android/gms/common/api/internal/ao;-><init>(Lcom/google/android/gms/common/api/internal/zzs;Landroid/os/IBinder;B)V

    invoke-virtual {v4, v7}, Lcom/google/android/gms/common/api/internal/zzs;->zza(Lcom/google/android/gms/common/api/internal/ap;)V
    ...
    invoke-virtual {v5, v6}, Lcom/google/android/gms/common/api/zzf;->remove(I)V
