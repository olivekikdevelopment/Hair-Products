...
.method static declared-synchronized a(Landroid/content/Context;I)V
    ...
    const-class v0, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;->a:Landroid/content/BroadcastReceiver;
    :try_end_0
    ...
    :cond_0
    :try_start_1
    new-instance v1, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;

    invoke-direct {v1, p1}, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;-><init>(I)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;->a:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    sget-object p1, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;->a:Landroid/content/BroadcastReceiver;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-class p2, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;
    ...
    iget v0, p0, Lcom/google/firebase/iid/FirebaseInstanceIdService$a;->b:I

    invoke-static {v0}, Lcom/google/firebase/iid/FirebaseInstanceIdService;->a(I)Landroid/content/Intent;

    move-result-object v0

    invoke-virtual {p2, p1, v0}, Lcom/google/firebase/iid/o;->a(Landroid/content/Context;Landroid/content/Intent;)V
