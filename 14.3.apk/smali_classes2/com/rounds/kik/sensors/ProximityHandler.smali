...
.method private declared-synchronized changeProximity(Z)V
    ...
    .line 110
    sget-object p1, Lcom/rounds/kik/sensors/ProximityHandler;->LOGGER:Lcom/rounds/kik/logs/VideoLogger;

    const-string v0, "proximity near ear"
    ...
    const-string v0, "acquire lock with timeout= 1200000"
    ...
    const-string v0, "lock already held "
    ...
    const-string v0, "apparently older than API21 - turning screen off"
    ...
    const-string v0, "proximity far from ear"
    ...
    const-string v0, "releasing proximity wakelock "
    ...
    const-string v0, "apparently older than API21 - turning screen on "
