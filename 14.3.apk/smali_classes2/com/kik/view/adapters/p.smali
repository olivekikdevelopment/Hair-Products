...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 42
    invoke-direct/range {v0 .. v5}, Lcom/kik/view/adapters/p;-><init>(Landroid/content/Context;Ljava/util/ArrayList;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;Lkik/core/datatypes/MemberPermissions$Type;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;Lkik/core/datatypes/MemberPermissions$Type;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0, p3, p4}, Lcom/kik/view/adapters/a;-><init>(Landroid/content/Context;Lkik/android/chat/vm/IListViewModel;Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    .line 52
    invoke-interface {p3, p0}, Lcom/kik/components/CoreComponent;->a(Lcom/kik/view/adapters/p;)V

    .line 53
    iget-object p1, p0, Lcom/kik/view/adapters/p;->e:Lcom/kik/storage/y;

    invoke-interface {p1}, Lcom/kik/storage/y;->a()Lcom/kik/cache/KikVolleyImageLoader;

    move-result-object p1

    iput-object p1, p0, Lcom/kik/view/adapters/p;->b:Lcom/kik/cache/KikVolleyImageLoader;
...
.method protected final a(ILandroid/view/View;Landroid/view/ViewGroup;Landroid/databinding/ViewDataBinding;)V
    ...
    .line 72
    iget-object p3, p0, Lcom/kik/view/adapters/p;->a:Ljava/util/ArrayList;
    ...
    .line 1113
    :goto_1
    iget-object v1, p2, Lcom/kik/view/adapters/g;->f:Landroid/widget/TextView;
    ...
    iput-object v0, p2, Lcom/kik/view/adapters/g;->b:Ljava/lang/String;

    .line 80
    iget-object v0, p2, Lcom/kik/view/adapters/g;->e:Landroid/widget/TextView;

    invoke-virtual {v0, p4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 82
    iget-object p4, p2, Lcom/kik/view/adapters/g;->c:Lcom/kik/cache/ContactImageView;

    iget-object v0, p0, Lcom/kik/view/adapters/p;->b:Lcom/kik/cache/KikVolleyImageLoader;

    iget-object v1, p0, Lcom/kik/view/adapters/p;->d:Lkik/core/interfaces/w;

    iget-object v2, p0, Lcom/kik/view/adapters/p;->c:Lcom/kik/android/Mixpanel;
    ...
    .line 85
    iget-object p3, p2, Lcom/kik/view/adapters/g;->d:Landroid/widget/ImageView;
    ...
    .line 87
    :cond_2
    iget-object p3, p0, Lcom/kik/view/adapters/p;->f:Lkik/core/datatypes/MemberPermissions$Type;
    ...
    invoke-virtual {p2, p1, p3}, Lcom/kik/view/adapters/g;->a(II)V
