...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Activity;Ljava/lang/String;)V
    ...
    .line 29
    sget-object p1, Lcom/vidyo/LmiDeviceManager/LmiVideoCapturer;->LOGGER:Lcom/rounds/kik/logs/VideoLogger;

    const-string p2, "Creating video capturer internal"
    ...
    const-string p2, "Video capturer internal created"
...
.method public start(Ljava/lang/String;III)Z
    ...
    invoke-virtual {v0, v2, v3}, Lcom/rounds/kik/logs/VideoLogger;->videoInfo(Ljava/lang/String;[Ljava/lang/Object;)V

    if-nez p1, :cond_1

    .line 65
    sget-object p2, Lcom/vidyo/LmiDeviceManager/LmiVideoCapturer;->LOGGER:Lcom/rounds/kik/logs/VideoLogger;

    const-string p3, "Failed to start camera"

    invoke-virtual {p2, p3}, Lcom/rounds/kik/logs/VideoLogger;->videoInfo(Ljava/lang/String;)V
