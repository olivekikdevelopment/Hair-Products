...
.method static synthetic a(Lio/branch/referral/i;)Landroid/app/Dialog;
    ...
    .line 37
    iget-object p0, p0, Lio/branch/referral/i;->h:Landroid/app/Dialog;
...
.method static synthetic a(Lio/branch/referral/i;Lio/branch/referral/i$a;Lio/branch/referral/i$b;Landroid/webkit/WebView;)V
    ...
    .line 2025
    invoke-static {v3}, Lio/branch/referral/m;->u(Ljava/lang/String;)I
    ...
    .line 2026
    invoke-static {v2, v3}, Lio/branch/referral/m;->b(Ljava/lang/String;I)V
    ...
    iput-object v2, p0, Lio/branch/referral/i;->f:Ljava/lang/String;
    ...
    .line 1182
    iget-object v3, p0, Lio/branch/referral/i;->h:Landroid/app/Dialog;
    ...
    invoke-interface {p2, p0}, Lio/branch/referral/i$b;->c(Ljava/lang/String;)V
    ...
    iput-object v3, p0, Lio/branch/referral/i;->h:Landroid/app/Dialog;
    ...
    .line 1194
    invoke-static {v2}, Lio/branch/referral/i;->a(Landroid/view/View;)V
    ...
    .line 1201
    iget-object p3, p0, Lio/branch/referral/i;->h:Landroid/app/Dialog;

    new-instance v0, Lio/branch/referral/i$2;

    invoke-direct {v0, p0, p2, p1}, Lio/branch/referral/i$2;-><init>(Lio/branch/referral/i;Lio/branch/referral/i$b;Lio/branch/referral/i$a;)V
...
.method private a(Lio/branch/referral/i$a;Landroid/content/Context;Lio/branch/referral/i$b;)Z
    ...
    .line 87
    iget-boolean v0, p0, Lio/branch/referral/i;->b:Z

    const/4 v1, 0x0

    if-nez v0, :cond_4

    iget-boolean v0, p0, Lio/branch/referral/i;->e:Z
    ...
    .line 106
    :cond_1
    iput-boolean v2, p0, Lio/branch/referral/i;->e:Z

    .line 107
    new-instance v0, Lio/branch/referral/i$c;

    invoke-direct {v0, p0, p1, p2, p3}, Lio/branch/referral/i$c;-><init>(Lio/branch/referral/i;Lio/branch/referral/i$a;Landroid/content/Context;Lio/branch/referral/i$b;)V

    new-array p1, v1, [Ljava/lang/Void;

    invoke-virtual {v0, p1}, Lio/branch/referral/i$c;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    invoke-interface {p3, p1}, Lio/branch/referral/i$b;->c(Ljava/lang/String;)V
...
.method private b(Lio/branch/referral/i$a;Landroid/content/Context;Lio/branch/referral/i$b;)V
    ...
    .line 128
    iput-boolean p2, p0, Lio/branch/referral/i;->g:Z
    ...
    .line 135
    new-instance p2, Lio/branch/referral/i$1;

    invoke-direct {p2, p0, p1, p3, v6}, Lio/branch/referral/i$1;-><init>(Lio/branch/referral/i;Lio/branch/referral/i$a;Lio/branch/referral/i$b;Landroid/webkit/WebView;)V
...
.method static synthetic e(Lio/branch/referral/i;)Z
    ...
    .line 37
    iget-boolean p0, p0, Lio/branch/referral/i;->c:Z
...
.method public final a(Landroid/app/Activity;)V
    ...
    .line 418
    iput-boolean p1, p0, Lio/branch/referral/i;->b:Z
...
.method public final a(Lorg/json/JSONObject;Ljava/lang/String;)Z
    ...
    iget-object v2, v2, Lio/branch/referral/Branch;->c:Ljava/lang/ref/WeakReference;
    ...
    .line 271
    invoke-static {v0, v2}, Lio/branch/referral/i$a;->a(Lio/branch/referral/i$a;Landroid/content/Context;)Z
