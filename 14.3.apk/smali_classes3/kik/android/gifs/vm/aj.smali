...
.field protected a:Lkik/android/util/ao;
...
.field private n:Lkik/android/util/cm;
...
# direct methods
.method public constructor <init>(Lkik/android/gifs/api/GifApiProvider;Lkik/android/chat/fragment/KikChatFragment$b;Lkik/android/util/cm;Ljava/lang/String;)V
    .locals 3
    ...
    iput-object v2, p0, Lkik/android/gifs/vm/aj;->q:Lrx/subjects/a;
    ...
    iput-object v1, p0, Lkik/android/gifs/vm/aj;->r:Lrx/subjects/a;
    ...
    .line 81
    iput-object p3, p0, Lkik/android/gifs/vm/aj;->n:Lkik/android/util/cm;
...
.method static synthetic a(Lkik/android/gifs/vm/aj;)I
    ...
    invoke-virtual {p0}, Lkik/android/gifs/vm/ab;->g()I
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Ljava/lang/Boolean;Ljava/lang/Boolean;)Ljava/lang/Integer;
    ...
    iget p0, p0, Lkik/android/gifs/vm/aj;->p:I
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Ljava/lang/String;Ljava/lang/Boolean;Lkik/android/widget/GifTrayPage;)Ljava/lang/String;
    ...
    iget-object p3, p0, Lkik/android/gifs/vm/aj;->c:Lkik/core/interfaces/ICommunication;
    ...
    .line 149
    iget-object p0, p0, Lkik/android/gifs/vm/aj;->b:Landroid/content/res/Resources;
    ...
    iget-object p2, p0, Lkik/android/gifs/vm/aj;->c:Lkik/core/interfaces/ICommunication;
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lkik/android/gifs/vm/c;->j()V
    ...
    invoke-virtual {p0, p1}, Lkik/android/gifs/vm/ab;->a(Ljava/lang/String;)V
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Ljava/lang/String;ZZ)V
    ...
    iget-object v1, p0, Lkik/android/gifs/vm/aj;->o:Ljava/lang/String;
    ...
    .line 8489
    :cond_2
    iget-boolean p3, p0, Lkik/android/gifs/vm/aj;->i:Z
    ...
    .line 8495
    iget-object p2, p0, Lkik/android/gifs/vm/aj;->k:Lkik/android/gifs/api/GifApiProvider;
    ...
    invoke-virtual {p0}, Lkik/android/gifs/vm/z;->e()V
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Lkik/android/gifs/vm/bo;Ljava/lang/Boolean;)V
    ...
    .line 2455
    iget-object v3, p0, Lkik/android/gifs/vm/aj;->d:Lcom/kik/android/Mixpanel;
    ...
    .line 2464
    iget-boolean p1, p0, Lkik/android/gifs/vm/aj;->i:Z
    ...
    .line 2507
    iget-object p2, p0, Lkik/android/gifs/vm/aj;->o:Ljava/lang/String;
    ...
    .line 2509
    :goto_0
    iget-object p0, p0, Lkik/android/gifs/vm/aj;->d:Lcom/kik/android/Mixpanel;
...
.method static synthetic a(Lkik/android/gifs/vm/aj;Lkik/android/widget/GifTrayPage;)V
    ...
    invoke-virtual {p1}, Lkik/android/gifs/vm/c;->j()V

    .line 8291
    iget-object p1, p0, Lkik/android/gifs/vm/aj;->t:Lrx/subjects/a;

    iget-object p0, p0, Lkik/android/gifs/vm/aj;->m:Lkik/android/widget/GifTrayPage;
...
.method private a(Lkik/android/gifs/vm/bo;)V
    ...
    invoke-virtual {p1}, Lkik/android/gifs/vm/z;->j()V
...
.method static synthetic b(Lkik/android/gifs/vm/aj;)V
    ...
    invoke-virtual {p0}, Lkik/android/gifs/vm/z;->j()V
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 91
    iget-object v0, p0, Lkik/android/gifs/vm/aj;->a:Lkik/android/util/ao;
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/z;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/ab;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/p;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/d;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/ae;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/t;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    invoke-virtual {v0, p1, p2}, Lkik/android/gifs/vm/l;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    .line 105
    invoke-virtual {p0}, Lkik/android/gifs/vm/aj;->ao_()Lrx/f/b;
    ...
    invoke-virtual {p2}, Lkik/android/gifs/vm/ab;->n()Lrx/d;
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/p;->n()Lrx/d;
    ...
    invoke-virtual {v1}, Lkik/android/gifs/vm/d;->n()Lrx/d;
    ...
    invoke-virtual {v2}, Lkik/android/gifs/vm/l;->n()Lrx/d;
    ...
    invoke-static {v0}, Lkik/android/gifs/vm/ak;->a(Lrx/subjects/a;)Lrx/functions/b;
    ...
    invoke-virtual {p2}, Lkik/android/gifs/vm/ab;->o()Lrx/d;
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/p;->o()Lrx/d;
    ...
    invoke-virtual {v1}, Lkik/android/gifs/vm/d;->o()Lrx/d;
    ...
    invoke-virtual {v2}, Lkik/android/gifs/vm/l;->o()Lrx/d;
    ...
    invoke-static {v0}, Lkik/android/gifs/vm/av;->a(Lrx/subjects/a;)Lrx/functions/b;
    ...
    invoke-virtual {p2}, Lkik/android/gifs/vm/t;->k()Lrx/d;

    move-result-object p2

    iget-object v0, p0, Lkik/android/gifs/vm/aj;->s:Lrx/subjects/a;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v0}, Lkik/android/gifs/vm/bc;->a(Lrx/subjects/a;)Lrx/functions/b;
    ...
    invoke-virtual {p2}, Lkik/android/gifs/vm/z;->d()Lrx/d;
    ...
    iget-object p2, p0, Lkik/android/gifs/vm/aj;->m:Lkik/android/widget/GifTrayPage;

    invoke-virtual {p1, p2}, Lkik/android/gifs/vm/ae;->a(Lkik/android/widget/GifTrayPage;)V
    ...
    invoke-virtual {p1, p2}, Lkik/android/gifs/vm/z;->a(Lkik/android/widget/GifTrayPage;)V
...
.method public final a(Lkik/core/interfaces/h;)V
    ...
    invoke-virtual {p1}, Lkik/android/gifs/vm/z;->l()V
...
.method public final at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/t;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/z;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/ab;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/p;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/d;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/ae;->at_()V
    ...
    invoke-virtual {v0}, Lkik/android/gifs/vm/l;->at_()V

    :cond_6
    const/4 v0, 0x0

    .line 269
    iput-object v0, p0, Lkik/android/gifs/vm/aj;->k:Lkik/android/gifs/api/GifApiProvider;

    .line 270
    iput-object v0, p0, Lkik/android/gifs/vm/aj;->l:Lkik/android/chat/fragment/KikChatFragment$b;

    .line 271
    iput-object v0, p0, Lkik/android/gifs/vm/aj;->n:Lkik/android/util/cm;
...
.method public final t()Lkik/android/gifs/vm/z;
    ...
    iget-object v1, p0, Lkik/android/gifs/vm/aj;->n:Lkik/android/util/cm;
    ...
    invoke-direct {v0, v1, v2, v3}, Lkik/android/gifs/vm/z;-><init>(Lkik/android/util/cm;Lkik/android/chat/fragment/KikChatFragment$b;Lrx/functions/f;)V
