.class public Lkik/android/chat/vm/messaging/dp;
.super Lkik/android/chat/vm/messaging/cl;
.source "SourceFile"

# interfaces
.implements Lkik/android/chat/vm/messaging/dx;
...
.method public constructor <init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;)V
    ...
    invoke-direct/range {v1 .. v9}, Lkik/android/chat/vm/messaging/cl;-><init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;)V

    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/messaging/dp;Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Drawable;
    .locals 1

    .line 101
    new-instance v0, Landroid/graphics/drawable/BitmapDrawable;

    iget-object p0, p0, Lkik/android/chat/vm/messaging/dp;->a:Landroid/content/res/Resources;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/dp;)Lrx/d;
    .locals 2
    ...
    invoke-direct {p0, v0, v1}, Lkik/android/chat/vm/messaging/dp;->a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;
...
.method private a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;
    ...
    .line 77
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/dp;->k()Lkik/core/datatypes/messageExtensions/ContentMessage;
    ...
    .line 81
    iget-object v0, p0, Lkik/android/chat/vm/messaging/dp;->I:Lkik/android/gifs/c;
...
.method static synthetic aS()Lrx/d;
    .locals 1
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 64
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/messaging/dp;)V
...
.method public final ab()V
    ...
    .line 149
    new-instance v1, Lkik/android/chat/vm/i;

    invoke-direct {v1, v0}, Lkik/android/chat/vm/i;-><init>(Ljava/lang/String;)V
    ...
    .line 154
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/dp;->p()Lkik/core/datatypes/Message;
    ...
    .line 155
    invoke-static {v0}, Lkik/android/chat/vm/messaging/dp;->d(Ljava/lang/String;)Z

    move-result v2

    invoke-virtual {v1, v2}, Lkik/android/chat/vm/j$a;->a(Z)Lkik/android/chat/vm/j$a;

    move-result-object v1

    .line 156
    invoke-virtual {v1}, Lkik/android/chat/vm/j$a;->a()Lkik/android/chat/vm/j;

    move-result-object v1

    .line 159
    :goto_0
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/dp;->S_()Lkik/android/chat/vm/bm;

    move-result-object v2

    invoke-interface {v2, v1}, Lkik/android/chat/vm/bm;->a(Lkik/android/chat/vm/bg;)Lrx/d;

    .line 161
    iget-object v1, p0, Lkik/android/chat/vm/messaging/dp;->H:Lcom/kik/android/Mixpanel;
...
.method public final g()Lrx/d;
    ...
    invoke-virtual {v2, v0}, Lkik/core/util/g;->a(Lkik/core/datatypes/r;)[B
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/dq;->a(Lkik/android/chat/vm/messaging/dp;)Lrx/functions/g;
    ...
    .line 110
    invoke-direct {p0, v0, v2}, Lkik/android/chat/vm/messaging/dp;->a(Lkik/core/datatypes/messageExtensions/ContentMessage$ContentLinkFileType;Lkik/android/gifs/api/GifResponseData$MediaType;)Lrx/d;

    move-result-object v0

    invoke-static {p0}, Lkik/android/chat/vm/messaging/dr;->a(Lkik/android/chat/vm/messaging/dp;)Lrx/functions/g;
