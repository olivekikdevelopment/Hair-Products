.class public final Lkik/android/chat/vm/messaging/fs;
.super Lkik/android/chat/vm/messaging/cl;
.source "SourceFile"
...
.method public constructor <init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;)V
    ...
    .line 69
    invoke-direct/range {p0 .. p8}, Lkik/android/chat/vm/messaging/cl;-><init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;Lrx/d;)V
    ...
    iput-object p2, p0, Lkik/android/chat/vm/messaging/fs;->J:Lrx/subjects/a;
    ...
    iput-object p2, p0, Lkik/android/chat/vm/messaging/fs;->L:Lrx/subjects/a;
    ...
    iput-object p2, p0, Lkik/android/chat/vm/messaging/fs;->M:Lrx/subjects/a;
    ...
    iput-object p2, p0, Lkik/android/chat/vm/messaging/fs;->N:Lrx/subjects/a;

    .line 56
    iput p1, p0, Lkik/android/chat/vm/messaging/fs;->O:I
    ...
    iput-object p1, p0, Lkik/android/chat/vm/messaging/fs;->I:Lkik/android/HeadphoneUnpluggedReceiver;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/fs;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
...
.method static synthetic a(Lkik/android/chat/vm/messaging/fs;Ljava/lang/Boolean;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
    ...
    invoke-direct {p0}, Lkik/android/chat/vm/messaging/fs;->aT()Z
...
.method static synthetic a(Lkik/android/chat/vm/messaging/fs;Ljava/lang/Boolean;Lkik/android/chat/vm/messaging/IContentMessageViewModel$ItemUploadState;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
...
.method static synthetic a(Lkik/android/chat/vm/messaging/fs;)V
    .locals 1

    .line 192
    iget-object p0, p0, Lkik/android/chat/vm/messaging/fs;->L:Lrx/subjects/a;
...
.method static synthetic a(Lkik/android/chat/vm/messaging/fs;Lkik/android/net/http/a;Lkik/core/datatypes/f;Ljava/lang/String;)V
    .locals 0

    .line 36
    invoke-direct {p0, p1, p2, p3}, Lkik/android/chat/vm/messaging/fs;->a(Lkik/android/net/http/a;Lkik/core/datatypes/f;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lkik/android/chat/vm/messaging/fs;Lkik/core/datatypes/messageExtensions/ContentMessage;Lrx/j;)V
    .locals 3

    .line 131
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->B:Lcom/kik/storage/y;
    ...
    .line 140
    invoke-direct {p0}, Lkik/android/chat/vm/messaging/fs;->aS()Z
    ...
    iget-object v2, p0, Lkik/android/chat/vm/messaging/fs;->n:Lcom/kik/android/Mixpanel;
    ...
    .line 149
    new-instance v1, Lkik/android/chat/vm/messaging/fs$1;

    invoke-direct {v1, p0, p2, p1}, Lkik/android/chat/vm/messaging/fs$1;-><init>(Lkik/android/chat/vm/messaging/fs;Lrx/j;Lkik/core/datatypes/messageExtensions/ContentMessage;)V
...
.method private a(Lkik/android/net/http/a;Lkik/core/datatypes/f;Ljava/lang/String;)V
    ...
    .line 394
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->G_()Z
    ...
    .line 395
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->S_()Lkik/android/chat/vm/bm;

    move-result-object v0

    iget-object v1, p0, Lkik/android/chat/vm/messaging/fs;->a:Landroid/content/res/Resources;
    ...
    .line 397
    iget-object v1, p0, Lkik/android/chat/vm/messaging/fs;->A:Lkik/core/interfaces/ad;

    invoke-virtual {p2, p3, v0, v1}, Lkik/core/datatypes/f;->a(Ljava/lang/String;ILkik/core/interfaces/ad;)Z

    .line 398
    iget-object p2, p0, Lkik/android/chat/vm/messaging/fs;->b:Lkik/android/net/http/b;
...
.method private aS()Z
    ...
    .line 216
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->H:Lkik/core/interfaces/t;
    ...
    .line 220
    :cond_0
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->a:Landroid/content/res/Resources;
    ...
    .line 221
    iget-object v3, p0, Lkik/android/chat/vm/messaging/fs;->A:Lkik/core/interfaces/ad;
    ...
    .line 223
    iget-object v4, p0, Lkik/android/chat/vm/messaging/fs;->a:Landroid/content/res/Resources;
    ...
    .line 229
    :cond_1
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->A:Lkik/core/interfaces/ad;
    ...
    .line 230
    iget-object v3, p0, Lkik/android/chat/vm/messaging/fs;->a:Landroid/content/res/Resources;
...
.method static synthetic b(Lkik/android/chat/vm/messaging/fs;)I
    .locals 0

    .line 36
    iget p0, p0, Lkik/android/chat/vm/messaging/fs;->O:I
...
.method static synthetic b(Lkik/android/chat/vm/messaging/fs;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
...
.method static synthetic c(Lkik/android/chat/vm/messaging/fs;)Z
    .locals 0
...
.method static synthetic d(Lkik/android/chat/vm/messaging/fs;)Landroid/content/res/Resources;
    .locals 0

    .line 36
    iget-object p0, p0, Lkik/android/chat/vm/messaging/fs;->a:Landroid/content/res/Resources;

    return-object p0
.end method

.method static synthetic e(Lkik/android/chat/vm/messaging/fs;)Lkik/android/chat/vm/bm;
    .locals 0
...
.method static synthetic f(Lkik/android/chat/vm/messaging/fs;)Z
    .locals 0
...
.method static synthetic g(Lkik/android/chat/vm/messaging/fs;)Landroid/content/res/Resources;
    .locals 0
...
.method static synthetic h(Lkik/android/chat/vm/messaging/fs;)Lkik/android/chat/vm/bm;
    .locals 0
...
.method public final T()V
    ...
    .line 480
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->J:Lrx/subjects/a;
...
.method public final W()V
    ...
    .line 408
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->aK_()V
    ...
    .line 427
    :cond_2
    iget-object v1, p0, Lkik/android/chat/vm/messaging/fs;->z:Lkik/android/chat/presentation/MediaTrayPresenter;
    ...
    new-instance v2, Lkik/android/chat/vm/messaging/fs$3;

    invoke-direct {v2, p0, v0}, Lkik/android/chat/vm/messaging/fs$3;-><init>(Lkik/android/chat/vm/messaging/fs;Lkik/core/datatypes/messageExtensions/ContentMessage;)V
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 83
    invoke-super {p0, p1, p2}, Lkik/android/chat/vm/messaging/cl;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 10247
    iget-object p1, p0, Lkik/android/chat/vm/messaging/fs;->B:Lcom/kik/storage/y;
    ...
    .line 88
    iget-object p1, p0, Lkik/android/chat/vm/messaging/fs;->M:Lrx/subjects/a;
    ...
    .line 89
    iget-object p1, p0, Lkik/android/chat/vm/messaging/fs;->J:Lrx/subjects/a;
    ...
    iput-object p1, p0, Lkik/android/chat/vm/messaging/fs;->K:Lrx/d;

    goto :goto_1

    .line 11128
    :cond_3
    invoke-static {p0, p1}, Lkik/android/chat/vm/messaging/ft;->a(Lkik/android/chat/vm/messaging/fs;Lkik/core/datatypes/messageExtensions/ContentMessage;)Lrx/d$a;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/fu;->a(Lkik/android/chat/vm/messaging/fs;)Lrx/functions/b;
    ...
    .line 11196
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->n()Lrx/d;

    move-result-object p2

    invoke-static {p1}, Lkik/android/chat/vm/messaging/fv;->a(Lrx/d;)Lrx/functions/g;
    ...
    .line 94
    :goto_1
    iget-object p1, p0, Lkik/android/chat/vm/messaging/fs;->I:Lkik/android/HeadphoneUnpluggedReceiver;
...
.method public final aB_()Lrx/d;
    ...
    .line 295
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->L:Lrx/subjects/a;

    iget-object v1, p0, Lkik/android/chat/vm/messaging/fs;->J:Lrx/subjects/a;

    invoke-static {p0}, Lkik/android/chat/vm/messaging/fy;->a(Lkik/android/chat/vm/messaging/fs;)Lrx/functions/h;
...
.method public final aC_()Lrx/d;
    ...
    .line 311
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->M:Lrx/subjects/a;
...
.method public final aD_()Lrx/d;
    ...
    .line 317
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->N:Lrx/subjects/a;
...
.method public final aE_()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/fz;->a(Lkik/android/chat/vm/messaging/fs;)Lrx/functions/g;
...
.method public final aF_()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/messaging/ga;->a(Lkik/android/chat/vm/messaging/fs;)Lrx/functions/g;
...
.method public final aG_()V
    ...
    iget-object v3, p0, Lkik/android/chat/vm/messaging/fs;->B:Lcom/kik/storage/y;
...
.method public final aO()V
    ...
    .line 354
    invoke-super {p0}, Lkik/android/chat/vm/messaging/cl;->aO()V
...
.method public final aP()V
    ...
    .line 360
    invoke-super {p0}, Lkik/android/chat/vm/messaging/cl;->aP()V

    .line 361
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->i:Lkik/core/interfaces/IConversation;

    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->m()Ljava/lang/String;
    ...
    .line 362
    iget-object v1, p0, Lkik/android/chat/vm/messaging/fs;->b:Lkik/android/net/http/b;
    ...
    .line 12371
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->p()Lkik/core/datatypes/Message;
    ...
    .line 12377
    new-instance v2, Lkik/android/chat/vm/messaging/fs$2;

    invoke-direct {v2, p0, v1, v0}, Lkik/android/chat/vm/messaging/fs$2;-><init>(Lkik/android/chat/vm/messaging/fs;Lkik/android/net/http/a;Lkik/core/datatypes/f;)V
    ...
    invoke-direct {p0, v1, v0, v2}, Lkik/android/chat/vm/messaging/fs;->a(Lkik/android/net/http/a;Lkik/core/datatypes/f;Ljava/lang/String;)V
...
.method public final at_()V
    ...
    .line 100
    invoke-super {p0}, Lkik/android/chat/vm/messaging/cl;->at_()V

    .line 102
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->I:Lkik/android/HeadphoneUnpluggedReceiver;
    ...
    .line 103
    iput-object v0, p0, Lkik/android/chat/vm/messaging/fs;->I:Lkik/android/HeadphoneUnpluggedReceiver;
...
.method public final h()Lrx/d;
    ...
    .line 115
    iget-object v0, p0, Lkik/android/chat/vm/messaging/fs;->K:Lrx/d;
...
.method public final i()Lrx/d;
    ...
    .line 284
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->A()Lrx/d;

    move-result-object v0

    .line 285
    invoke-virtual {p0}, Lkik/android/chat/vm/messaging/fs;->aJ()Lrx/d;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/vm/messaging/fs;->J:Lrx/subjects/a;

    invoke-static {p0}, Lkik/android/chat/vm/messaging/fx;->a(Lkik/android/chat/vm/messaging/fs;)Lrx/functions/i;
...
.method public final n()Lrx/d;
    ...
    invoke-static {}, Lkik/android/chat/vm/messaging/gb;->a()Lrx/functions/h;
