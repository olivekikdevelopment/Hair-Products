...
.field private w:Lkik/android/chat/vm/fu;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private y:Lkik/android/chat/vm/chats/profile/eb;
...
.method public constructor <init>(Lcom/kik/core/domain/a/a/a;)V
    ...
    invoke-direct/range {v0 .. v5}, Lkik/android/chat/vm/profile/bz;-><init>(Lcom/kik/core/network/xmpp/jid/a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public constructor <init>(Lcom/kik/core/network/xmpp/jid/a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 69
    new-instance p1, Lkik/android/chat/vm/fu;

    invoke-direct {p1}, Lkik/android/chat/vm/fu;-><init>()V

    iput-object p1, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;
    ...
    iput-object p1, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    .line 81
    iput-object p2, p0, Lkik/android/chat/vm/profile/bz;->s:Ljava/lang/String;

    .line 82
    iput-object p3, p0, Lkik/android/chat/vm/profile/bz;->t:Ljava/lang/String;

    .line 83
    iput-object p4, p0, Lkik/android/chat/vm/profile/bz;->u:Ljava/lang/String;

    .line 84
    iput-boolean p5, p0, Lkik/android/chat/vm/profile/bz;->v:Z
    ...
    .line 1096
    invoke-virtual {p0, p3}, Lkik/android/chat/vm/profile/bz;->a(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/ca;->a(Lkik/android/chat/vm/profile/bz;)Ljava/lang/Runnable;
    ...
    .line 1101
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/bz;->S_()Lkik/android/chat/vm/bm;

    move-result-object p3

    invoke-interface {p3, p2}, Lkik/android/chat/vm/bm;->a(Lkik/android/chat/vm/DialogViewModel;)V

    .line 1103
    iget-object p2, p0, Lkik/android/chat/vm/profile/bz;->o:Lcom/kik/android/Mixpanel;
...
.method private K()V
    ...
    .line 130
    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->t:Ljava/lang/String;
    ...
    .line 131
    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->n:Lcom/kik/core/domain/a/a;

    iget-object v1, p0, Lkik/android/chat/vm/profile/bz;->s:Ljava/lang/String;
    ...
    iget-object v1, p0, Lkik/android/chat/vm/profile/bz;->t:Ljava/lang/String;
    ...
    .line 137
    :goto_0
    invoke-virtual {p0}, Lkik/android/chat/vm/profile/bz;->ao_()Lrx/f/b;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cf;->a(Lkik/android/chat/vm/profile/bz;)Lrx/functions/b;

    move-result-object v2

    invoke-static {p0}, Lkik/android/chat/vm/profile/cg;->a(Lkik/android/chat/vm/profile/bz;)Lrx/functions/b;
...
.method static synthetic a(Lkik/android/chat/vm/profile/bz;)V
    .locals 0
...
.method static synthetic a(Lkik/android/chat/vm/profile/bz;Lcom/kik/core/domain/a/a/a;)V
    .locals 5
    ...
    invoke-virtual {p0, v0, v3}, Lkik/android/chat/vm/profile/bz;->a(I[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, p1}, Lkik/android/chat/vm/profile/ce;->a(Lkik/android/chat/vm/profile/bz;Lcom/kik/core/domain/a/a/a;)Ljava/lang/Runnable;
...
.method static synthetic a(Lkik/android/chat/vm/profile/bz;Ljava/lang/Throwable;)V
    .locals 7

    .line 4169
    invoke-static {p0}, Lkik/android/chat/vm/profile/ch;->a(Lkik/android/chat/vm/profile/bz;)Ljava/lang/Runnable;
    ...
    .line 4174
    invoke-virtual {p0, v4}, Lkik/android/chat/vm/profile/bz;->a(I)Ljava/lang/String;
    ...
    .line 4177
    invoke-virtual {p0, v2}, Lkik/android/chat/vm/profile/bz;->a(I)Ljava/lang/String;
    ...
    .line 4196
    invoke-virtual {p0, v1}, Lkik/android/chat/vm/profile/bz;->a(I)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/vm/profile/ci;->a(Lkik/android/chat/vm/profile/bz;)Ljava/lang/Runnable;
    ...
    .line 4201
    iget-object p0, p0, Lkik/android/chat/vm/profile/bz;->o:Lcom/kik/android/Mixpanel;
...
.method static synthetic b(Lkik/android/chat/vm/profile/bz;)V
    .locals 0
...
.method static synthetic b(Lkik/android/chat/vm/profile/bz;Lcom/kik/core/domain/a/a/a;)V
    .locals 3
    ...
    invoke-static {p0, v0, p1}, Lkik/android/chat/vm/profile/cd;->a(Lkik/android/chat/vm/profile/bz;Ljava/lang/String;Lcom/kik/core/domain/a/a/a;)Ljava/lang/Runnable;
    ...
    invoke-interface {v0, p1}, Lkik/android/chat/vm/bm;->a(Lkik/android/chat/vm/bu;)V

    .line 2328
    iget-object p0, p0, Lkik/android/chat/vm/profile/bz;->k:Lcom/kik/metrics/c/d;
...
.method static synthetic c(Lkik/android/chat/vm/profile/bz;)Landroid/content/res/Resources;
    .locals 0

    .line 56
    iget-object p0, p0, Lkik/android/chat/vm/profile/bz;->a:Landroid/content/res/Resources;

    return-object p0
.end method

.method static synthetic c(Lkik/android/chat/vm/profile/bz;Lcom/kik/core/domain/a/a/a;)Ljava/lang/String;
    .locals 3
    ...
    invoke-virtual {p0, p1, v1}, Lkik/android/chat/vm/profile/bz;->a(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic d(Lkik/android/chat/vm/profile/bz;)V
    .locals 0

    invoke-direct {p0}, Lkik/android/chat/vm/profile/bz;->K()V

    return-void
.end method

.method static synthetic d(Lkik/android/chat/vm/profile/bz;Lcom/kik/core/domain/a/a/a;)V
    .locals 7

    .line 141
    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    invoke-virtual {v0, p1}, Lrx/subjects/a;->a(Ljava/lang/Object;)V

    .line 3333
    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;
    ...
    .line 3342
    sget-object v3, Lkik/android/chat/vm/profile/ek;->a:Ljava/util/Comparator;
    ...
    .line 3347
    iget-object v4, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    new-instance v5, Lkik/android/chat/vm/profile/gridvm/k;

    iget-object v6, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    invoke-direct {v5, v3, v6}, Lkik/android/chat/vm/profile/gridvm/k;-><init>(Lcom/kik/core/domain/a/a/b;Lrx/d;)V

    invoke-virtual {v4, v5}, Lkik/android/chat/vm/fu;->a(Lkik/android/chat/vm/bh;)V
    ...
    .line 3351
    iget-object v3, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    new-instance v4, Lkik/android/chat/vm/profile/gridvm/k;

    iget-object v5, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    invoke-direct {v4, v1, v5}, Lkik/android/chat/vm/profile/gridvm/k;-><init>(Lcom/kik/core/domain/a/a/b;Lrx/d;)V

    invoke-virtual {v3, v4}, Lkik/android/chat/vm/fu;->a(Lkik/android/chat/vm/bh;)V
    ...
    .line 3355
    iget-object v2, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    new-instance v3, Lkik/android/chat/vm/profile/gridvm/k;

    iget-object v4, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    invoke-direct {v3, v1, v4}, Lkik/android/chat/vm/profile/gridvm/k;-><init>(Lcom/kik/core/domain/a/a/b;Lrx/d;)V

    invoke-virtual {v2, v3}, Lkik/android/chat/vm/fu;->a(Lkik/android/chat/vm/bh;)V
    ...
    invoke-virtual {p0, p1}, Lkik/android/chat/vm/profile/bz;->a(Lcom/kik/core/network/xmpp/jid/a;)V

    .line 145
    iget-object p1, p0, Lkik/android/chat/vm/profile/bz;->t:Ljava/lang/String;

    if-nez p1, :cond_3

    iget-object p1, p0, Lkik/android/chat/vm/profile/bz;->u:Ljava/lang/String;

    if-eqz p1, :cond_4

    .line 146
    :cond_3
    new-instance p1, Lkik/android/chat/vm/profile/profileactionvm/ai;

    invoke-virtual {p0}, Lkik/android/chat/vm/profile/bz;->p()Lcom/kik/core/network/xmpp/jid/a;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/vm/profile/bz;->s:Ljava/lang/String;

    iget-object v3, p0, Lkik/android/chat/vm/profile/bz;->t:Ljava/lang/String;

    iget-object v4, p0, Lkik/android/chat/vm/profile/bz;->u:Ljava/lang/String;

    iget-boolean v5, p0, Lkik/android/chat/vm/profile/bz;->v:Z

    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    invoke-virtual {v0}, Lkik/android/chat/vm/fu;->g()I

    move-result v6

    move-object v0, p1

    invoke-direct/range {v0 .. v6}, Lkik/android/chat/vm/profile/profileactionvm/ai;-><init>(Lcom/kik/core/network/xmpp/jid/a;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI)V

    invoke-virtual {p0, p1}, Lkik/android/chat/vm/profile/bz;->a(Lkik/android/chat/vm/profile/ep;)V

    .line 4156
    :cond_4
    iget-object p1, p0, Lkik/android/chat/vm/profile/bz;->k:Lcom/kik/metrics/c/d;
    ...
    invoke-virtual {v0, v1}, Lcom/kik/metrics/b/bs$a;->a(Lcom/kik/metrics/b/p$h;)Lcom/kik/metrics/b/bs$a;

    move-result-object v0

    new-instance v1, Lcom/kik/metrics/b/p$q;

    iget-object p0, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    .line 4160
    invoke-virtual {p0}, Lkik/android/chat/vm/fu;->g()I
    ...
    invoke-direct {v1, p0}, Lcom/kik/metrics/b/p$q;-><init>(Ljava/lang/Integer;)V

    invoke-virtual {v0, v1}, Lcom/kik/metrics/b/bs$a;->a(Lcom/kik/metrics/b/p$q;)Lcom/kik/metrics/b/bs$a;

    move-result-object p0

    .line 4161
    invoke-virtual {p0}, Lcom/kik/metrics/b/bs$a;->a()Lcom/kik/metrics/b/bs;

    move-result-object p0

    .line 4158
    invoke-virtual {p1, p0}, Lcom/kik/metrics/c/d;->a(Lcom/kik/metrics/b/u;)V
...
.method public final H()Lkik/android/chat/vm/chats/profile/eb;
    ...
    .line 225
    iget-object v0, p0, Lkik/android/chat/vm/profile/bz;->y:Lkik/android/chat/vm/chats/profile/eb;
...
.method public final a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    .line 112
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lkik/android/chat/vm/profile/bz;)V

    .line 113
    invoke-super {p0, p1, p2}, Lkik/android/chat/vm/profile/b;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    .line 115
    iget-object p2, p0, Lkik/android/chat/vm/profile/bz;->w:Lkik/android/chat/vm/fu;

    invoke-virtual {p0, p2, p1}, Lkik/android/chat/vm/profile/bz;->a(Lkik/android/chat/vm/cg;Lcom/kik/components/CoreComponent;)Lkik/android/chat/vm/cg;

    .line 1391
    iget-object p2, p0, Lkik/android/chat/vm/profile/bz;->r:Lkik/core/interfaces/b;
    ...
    .line 118
    new-instance p2, Lkik/android/chat/vm/chats/profile/ca;

    invoke-virtual {p0}, Lkik/android/chat/vm/profile/bz;->p()Lcom/kik/core/network/xmpp/jid/a;

    move-result-object v1

    invoke-direct {p2, v1, v0}, Lkik/android/chat/vm/chats/profile/ca;-><init>(Lcom/kik/core/network/xmpp/jid/a;Z)V

    iput-object p2, p0, Lkik/android/chat/vm/profile/bz;->y:Lkik/android/chat/vm/chats/profile/eb;

    .line 119
    iget-object p2, p0, Lkik/android/chat/vm/profile/bz;->y:Lkik/android/chat/vm/chats/profile/eb;
...
.method public final d()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/cj;->a(Lkik/android/chat/vm/profile/bz;)Lrx/functions/g;
...
.method public final g()V
    ...
    iget-object v1, p0, Lkik/android/chat/vm/profile/bz;->x:Lrx/subjects/a;

    invoke-virtual {v1}, Lrx/subjects/a;->g()Lrx/d;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/vm/profile/cb;->a(Lkik/android/chat/vm/profile/bz;)Lrx/functions/b;
...
.method public final s()Lrx/d;
    ...
    invoke-static {p0}, Lkik/android/chat/vm/profile/ck;->a(Lkik/android/chat/vm/profile/bz;)Lrx/functions/g;
