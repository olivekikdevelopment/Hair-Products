...
.method public constructor <init>(Lkik/android/net/communicator/j;Lcom/kik/android/a/a;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 132
    :cond_0
    new-instance p1, Lkik/android/net/communicator/k$a;

    invoke-direct {p1, p0}, Lkik/android/net/communicator/k$a;-><init>(Lkik/android/net/communicator/k;)V

    iput-object p1, p0, Lkik/android/net/communicator/k;->q:Lkik/android/net/communicator/k$a;
...
.method private a(J)V
    ...
    iput-wide v2, p0, Lkik/android/net/communicator/k;->f:J
...
.method private a(Ljava/lang/String;IZ)V
    ...
    .line 156
    sget-object v2, Lkik/android/net/communicator/k;->o:Landroid/net/SSLCertificateSocketFactory;
    ...
    .line 159
    iput-object v2, p0, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;
    ...
    .line 176
    sget-object p2, Lkik/android/net/communicator/k;->p:Ljavax/net/ssl/HostnameVerifier;
    ...
    invoke-static {}, Lcom/kik/util/da;->a()V
...
.method private a(Lkik/core/net/security/StreamSecurityType;)V
    ...
    invoke-virtual {v0, v2, v1}, Lkik/core/net/g;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2036
    invoke-virtual {v1, v2, v3}, Lkik/core/net/g;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3036
    invoke-virtual {v3, v2, v4}, Lkik/core/net/g;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 4036
    invoke-virtual {v4, v2, v5}, Lkik/core/net/g;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 329
    :cond_5
    iget-object p1, p0, Lkik/android/net/communicator/k;->b:Lkik/core/net/g;
...
.method private a(Z)V
    ...
    .line 399
    :cond_0
    iget-object p1, p0, Lkik/android/net/communicator/k;->d:Lkik/android/net/b;

    if-eqz p1, :cond_2

    .line 400
    iget-object p1, p0, Lkik/android/net/communicator/k;->a:Lkik/core/net/h;
...
.method private b(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 658
    invoke-static {p1}, Lkik/android/util/cg;->a([B)Ljava/lang/String;
...
.method public final a(Ljava/lang/String;)V
    ...
    .line 10385
    invoke-direct {p0, p1}, Lkik/android/net/communicator/k;->a(Z)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkik/core/net/security/StreamSecurityType;I)V
    ...
    .line 509
    invoke-direct {v1, v2, v3, v14}, Lkik/android/net/communicator/k;->a(Ljava/lang/String;IZ)V
    ...
    .line 513
    invoke-direct {v1, v2, v3, v15}, Lkik/android/net/communicator/k;->a(Ljava/lang/String;IZ)V
    ...
    iput-object v8, v1, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;

    .line 7143
    iget-object v8, v1, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;
    ...
    .line 7144
    iget-object v3, v1, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;
    ...
    invoke-static {v8, v9}, Lkik/core/util/v;->c(J)J
    ...
    iput-object v9, v1, Lkik/android/net/communicator/k;->m:Ljava/lang/String;
    ...
    .line 7213
    iget-object v3, v1, Lkik/android/net/communicator/k;->m:Ljava/lang/String;

    invoke-direct {v1, v2}, Lkik/android/net/communicator/k;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iget-object v11, v1, Lkik/android/net/communicator/k;->k:Ljava/lang/String;
    ...
    .line 7217
    iget-object v4, v1, Lkik/android/net/communicator/k;->m:Ljava/lang/String;

    invoke-direct {v1, v2}, Lkik/android/net/communicator/k;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v19

    iget-object v2, v1, Lkik/android/net/communicator/k;->k:Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v24}, Lkik/core/net/l;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, v1, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;

    invoke-direct {v5, v6}, Lkik/android/net/e;-><init>(Ljava/net/Socket;)V

    invoke-direct {v4, v10, v11, v12, v5}, Lkik/core/net/InterruptingOutputStream;-><init>(Ljava/io/OutputStream;JLkik/core/net/i;)V

    const-string v5, "KIK_XML_SND"

    invoke-direct {v3, v4, v5}, Lkik/android/net/b;-><init>(Ljava/io/OutputStream;Ljava/lang/String;)V

    iput-object v3, v1, Lkik/android/net/communicator/k;->d:Lkik/android/net/b;

    .line 7230
    iput-object v9, v1, Lkik/android/net/communicator/k;->c:Ljava/io/InputStream;

    .line 7231
    iget-object v3, v1, Lkik/android/net/communicator/k;->d:Lkik/android/net/b;
    ...
    iget-object v5, v1, Lkik/android/net/communicator/k;->g:Ljava/net/Socket;

    invoke-direct {v4, v5}, Lkik/android/net/e;-><init>(Ljava/net/Socket;)V

    const-wide/16 v5, 0x7530

    invoke-direct {v3, v2, v5, v6, v4}, Lkik/core/net/InterruptingOutputStream;-><init>(Ljava/io/OutputStream;JLkik/core/net/i;)V
    ...
    iput-object v2, v1, Lkik/android/net/communicator/k;->d:Lkik/android/net/b;
    ...
    iput-object v2, v1, Lkik/android/net/communicator/k;->c:Ljava/io/InputStream;
    ...
    iget-object v4, v1, Lkik/android/net/communicator/k;->c:Ljava/io/InputStream;
    ...
    iget-object v5, v1, Lkik/android/net/communicator/k;->j:Lcom/kik/android/a/a;

    invoke-direct {v2, v3, v4, v5}, Lkik/android/net/a;-><init>(Ljava/io/Reader;Ljava/lang/String;Lcom/kik/android/a/a;)V

    iput-object v2, v1, Lkik/android/net/communicator/k;->h:Lkik/android/net/a;
    ...
    iput-object v2, v1, Lkik/android/net/communicator/k;->b:Lkik/core/net/g;

    .line 7289
    iget-object v2, v1, Lkik/android/net/communicator/k;->b:Lkik/core/net/g;

    iget-object v3, v1, Lkik/android/net/communicator/k;->h:Lkik/android/net/a;
    ...
    iput-object v2, v1, Lkik/android/net/communicator/k;->a:Lkik/core/net/h;

    .line 7291
    iget-object v2, v1, Lkik/android/net/communicator/k;->a:Lkik/core/net/h;
    ...
    .line 7385
    invoke-direct {v1, v2}, Lkik/android/net/communicator/k;->a(Z)V

    .line 520
    invoke-direct {v1, v13}, Lkik/android/net/communicator/k;->a(Lkik/core/net/security/StreamSecurityType;)V
    ...
    .line 8379
    iget-object v2, v1, Lkik/android/net/communicator/k;->i:Lkik/android/net/communicator/j;

    iget-object v3, v1, Lkik/android/net/communicator/k;->b:Lkik/core/net/g;

    invoke-virtual {v2, v3, v1}, Lkik/android/net/communicator/j;->a(Lkik/core/net/g;Lkik/android/net/communicator/j$a;)V

    .line 8380
    new-instance v2, Ljava/lang/Thread;

    iget-object v3, v1, Lkik/android/net/communicator/k;->i:Lkik/android/net/communicator/j;
    ...
    .line 8385
    invoke-direct {v1, v3}, Lkik/android/net/communicator/k;->a(Z)V

    .line 533
    invoke-virtual/range {p0 .. p0}, Lkik/android/net/communicator/k;->a()V

    .line 534
    invoke-virtual/range {p0 .. p0}, Lkik/android/net/communicator/k;->c()V
...
.method public final a(Lkik/core/net/outgoing/k;)V
    ...
    .line 564
    new-instance v0, Lkik/core/net/h;

    invoke-direct {v0}, Lkik/core/net/h;-><init>()V
    ...
    invoke-virtual {v0, v2, v3}, Lkik/core/net/h;->a(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    .line 571
    :try_start_0
    invoke-virtual {p1, v0}, Lkik/core/net/outgoing/f;->writeOutgoingStanza(Lkik/core/net/h;)V
    :try_end_0
    ...
    .line 589
    iget-object p1, p0, Lkik/android/net/communicator/k;->q:Lkik/android/net/communicator/k$a;

    invoke-virtual {p1}, Lkik/android/net/communicator/k$a;->b()I
    ...
    invoke-virtual {v0}, Lkik/android/net/communicator/k$a;->a()[B

    move-result-object v0

    iget-object v3, p0, Lkik/android/net/communicator/k;->q:Lkik/android/net/communicator/k$a;

    invoke-virtual {v3}, Lkik/android/net/communicator/k$a;->b()I
    ...
    invoke-virtual {p1}, Lkik/android/net/communicator/k$a;->reset()V
