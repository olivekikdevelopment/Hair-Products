...
.method static synthetic a(Lkik/android/widget/al;)Landroid/widget/TextView;
    ...
    .line 21
    iget-object p0, p0, Lkik/android/widget/al;->b:Landroid/widget/TextView;
...
.method private b(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 87
    iget-object p1, p0, Lkik/android/widget/al;->a:Landroid/widget/EditText;

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lkik/android/util/cp;->a(Landroid/widget/EditText;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v0, p1}, Lkik/android/util/cp;->a(Landroid/widget/EditText;Landroid/graphics/drawable/Drawable;)V
...
.method public final a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v0, v1}, Lkik/android/util/at;->a(Landroid/view/View;Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-static {p1, v0}, Lkik/android/util/cp;->a(Landroid/widget/EditText;I)V
...
.method public final a(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, v0}, Lkik/android/util/cp;->a(Ljava/lang/CharSequence;Landroid/widget/TextView;)V

    .line 75
    iget-object p2, p0, Lkik/android/widget/al;->a:Landroid/widget/EditText;
    ...
    .line 80
    iget-object p1, p0, Lkik/android/widget/al;->b:Landroid/widget/TextView;

    const/16 p2, 0x64

    invoke-static {p1, p2}, Lkik/android/util/at;->a(Landroid/view/View;I)V
    ...
    invoke-static {p1, p2}, Lkik/android/util/cp;->a(Landroid/widget/EditText;I)V
