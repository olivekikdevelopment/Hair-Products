...
.method public constructor <init>(Landroid/graphics/Bitmap;Ljava/lang/String;)V
    ...
    .line 26
    iput v1, p0, Lkik/android/widget/q;->d:I
    ...
    .line 29
    iput-object v1, p0, Lkik/android/widget/q;->g:Landroid/graphics/Paint;

    const-wide/16 v1, 0x0

    .line 30
    iput-wide v1, p0, Lkik/android/widget/q;->h:D

    const/4 v1, 0x0

    .line 31
    iput v1, p0, Lkik/android/widget/q;->i:I

    .line 32
    iput v1, p0, Lkik/android/widget/q;->j:I
    ...
    iput-object v1, p0, Lkik/android/widget/q;->m:Landroid/graphics/Matrix;
    ...
    .line 46
    iget-object p2, p0, Lkik/android/widget/q;->a:Landroid/graphics/Bitmap;

    invoke-static {p2}, Lkik/android/widget/q;->a(Landroid/graphics/Bitmap;)Landroid/graphics/BitmapShader;

    move-result-object p2

    iput-object p2, p0, Lkik/android/widget/q;->l:Landroid/graphics/BitmapShader;
...
.method private b(Landroid/graphics/Bitmap;)V
    ...
    .line 236
    iput p1, p0, Lkik/android/widget/q;->i:I

    .line 237
    iput p1, p0, Lkik/android/widget/q;->j:I
    ...
    .line 5248
    :goto_0
    iget-object p1, p0, Lkik/android/widget/q;->b:Landroid/graphics/Bitmap;

    if-eqz p1, :cond_2

    iget-object p1, p0, Lkik/android/widget/q;->k:Landroid/graphics/BitmapShader;

    if-eqz p1, :cond_2

    iget p1, p0, Lkik/android/widget/q;->i:I

    if-eqz p1, :cond_2

    iget p1, p0, Lkik/android/widget/q;->j:I
    ...
    .line 5254
    :cond_1
    iget-object p1, p0, Lkik/android/widget/q;->m:Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lkik/android/widget/q;->b:Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Lkik/android/widget/q;->i:I
...
.method public a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    .line 65
    iget-object p1, p0, Lkik/android/widget/q;->a:Landroid/graphics/Bitmap;

    invoke-static {p1}, Lkik/android/widget/q;->a(Landroid/graphics/Bitmap;)Landroid/graphics/BitmapShader;

    move-result-object p1

    iput-object p1, p0, Lkik/android/widget/q;->l:Landroid/graphics/BitmapShader;
    ...
    iput-object p1, p0, Lkik/android/widget/q;->k:Landroid/graphics/BitmapShader;

    const/4 p1, 0x1

    .line 67
    iput p1, p0, Lkik/android/widget/q;->c:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 134
    :pswitch_0
    iget-wide v2, p0, Lkik/android/widget/q;->e:J
    ...
    iput-wide v2, p0, Lkik/android/widget/q;->h:D
    ...
    iget-object v4, p0, Lkik/android/widget/q;->k:Landroid/graphics/BitmapShader;
    ...
    iget-wide v4, p0, Lkik/android/widget/q;->h:D
    ...
    iput-wide v2, p0, Lkik/android/widget/q;->e:J
