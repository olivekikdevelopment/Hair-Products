...
# instance fields
.field protected a:Lkik/android/util/cn;
...
.method private a()V
    ...
    .line 92
    new-instance v0, Lkik/android/util/cn;

    invoke-direct {v0, p0}, Lkik/android/util/cn;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Lkik/android/widget/NavbarContainer;->a:Lkik/android/util/cn;
...
.method public static a(Lkik/android/widget/NavbarContainer;Lrx/d;)V
    ...
    invoke-static {p0}, Lkik/android/widget/cs;->a(Lkik/android/widget/NavbarContainer;)Lrx/functions/b;
    ...
    invoke-static {v0, v1, p0, p1, v2}, Lcom/kik/util/ci;->a(ILrx/functions/b;Landroid/view/View;Lrx/d;Ljava/lang/Object;)V
...
.method static synthetic a(Lkik/android/widget/NavbarContainer;Z)V
    ...
    invoke-static {p0, p1, v1, v0, v2}, Lkik/android/util/cp;->b(Landroid/view/View;IIII)V
...
.method public final a(Z)V
    ...
    .line 66
    :cond_0
    iget-object v0, p0, Lkik/android/widget/NavbarContainer;->a:Lkik/android/util/cn;

    invoke-static {p0, p1}, Lkik/android/widget/ct;->a(Lkik/android/widget/NavbarContainer;Z)Ljava/lang/Runnable;

    move-result-object p1

    invoke-virtual {v0, p1}, Lkik/android/util/cn;->a(Ljava/lang/Runnable;)V
