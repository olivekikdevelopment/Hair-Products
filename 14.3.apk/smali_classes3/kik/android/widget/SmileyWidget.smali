...
.field private i:Lkik/android/chat/vm/co;
...
.method public static a(Landroid/widget/ImageView;Lrx/functions/g;)V
    ...
    .line 47
    :cond_0
    invoke-static {p1}, Lkik/android/widget/df;->a(Lrx/functions/g;)Landroid/view/View$OnTouchListener;
...
.method public final a()V
    ...
    .line 124
    iput-object v0, p0, Lkik/android/widget/SmileyWidget;->i:Lkik/android/chat/vm/co;
...
.method public final a(Landroid/view/View;Lcom/kik/android/b/f;)Z
    ...
    invoke-direct {v0, v1, p0}, Lkik/android/chat/vm/widget/au;-><init>(Ljava/lang/String;Lkik/android/chat/presentation/MediaTrayPresenterImpl$b;)V
    ...
    iget-object v2, p0, Lkik/android/widget/SmileyWidget;->i:Lkik/android/chat/vm/co;

    invoke-virtual {v0, v1, v2}, Lkik/android/chat/vm/widget/au;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V
    ...
    check-cast v1, Lkik/android/e/da;

    .line 169
    invoke-virtual {v1, v0}, Lkik/android/e/da;->a(Lkik/android/chat/vm/widget/x;)V

    .line 171
    iget-object v0, p0, Lkik/android/widget/SmileyWidget;->e:Lkik/android/f/b;

    invoke-virtual {v1}, Lkik/android/e/da;->getRoot()Landroid/view/View;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 72
    new-instance p3, Lkik/android/chat/vm/co;

    invoke-direct {p3, p0}, Lkik/android/chat/vm/co;-><init>(Lkik/android/chat/fragment/KikScopedDialogFragment;)V

    iput-object p3, p0, Lkik/android/widget/SmileyWidget;->i:Lkik/android/chat/vm/co;
    ...
    .line 77
    new-instance p2, Lkik/android/chat/vm/widget/ax;

    iget-object p3, p0, Lkik/android/widget/SmileyWidget;->c:Lkik/android/chat/fragment/KikChatFragment$b;

    invoke-direct {p2, p0, p3}, Lkik/android/chat/vm/widget/ax;-><init>(Lkik/android/chat/presentation/MediaTrayPresenterImpl$b;Lkik/android/chat/fragment/KikChatFragment$b;)V

    iput-object p2, p0, Lkik/android/widget/SmileyWidget;->h:Lkik/android/chat/vm/widget/y;

    .line 78
    iget-object p2, p0, Lkik/android/widget/SmileyWidget;->h:Lkik/android/chat/vm/widget/y;

    invoke-virtual {p0}, Lkik/android/widget/SmileyWidget;->getCoreComponent()Lcom/kik/components/CoreComponent;

    move-result-object p3

    iget-object v0, p0, Lkik/android/widget/SmileyWidget;->i:Lkik/android/chat/vm/co;

    invoke-interface {p2, p3, v0}, Lkik/android/chat/vm/widget/y;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/bm;)V

    .line 79
    iget-object p2, p0, Lkik/android/widget/SmileyWidget;->h:Lkik/android/chat/vm/widget/y;

    invoke-virtual {p1, p2}, Lkik/android/e/ed;->a(Lkik/android/chat/vm/widget/y;)V

    .line 81
    invoke-virtual {p1}, Lkik/android/e/ed;->getRoot()Landroid/view/View;
...
.method public onDestroyView()V
    ...
    invoke-interface {v0}, Lkik/android/chat/vm/widget/y;->at_()V
