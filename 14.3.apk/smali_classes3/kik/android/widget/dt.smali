.class public final Lkik/android/widget/dt;
...
.method public constructor <init>(Lkik/android/widget/bk;Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput v0, p0, Lkik/android/widget/dt;->a:I
    ...
    iput v0, p0, Lkik/android/widget/dt;->b:I
    ...
    iput v0, p0, Lkik/android/widget/dt;->c:I

    const/4 v0, 0x0

    .line 25
    iput v0, p0, Lkik/android/widget/dt;->d:I

    const/4 v0, 0x3

    .line 26
    iput v0, p0, Lkik/android/widget/dt;->e:I

    const/16 v0, 0x30

    .line 27
    iput v0, p0, Lkik/android/widget/dt;->f:I

    .line 35
    iput-object p1, p0, Lkik/android/widget/dt;->g:Lkik/android/widget/bk;
    ...
    iput-object p1, p0, Lkik/android/widget/dt;->i:Landroid/view/View;

    .line 40
    iget-object p1, p0, Lkik/android/widget/dt;->i:Landroid/view/View;

    new-instance v0, Landroid/view/ViewGroup$LayoutParams;

    iget v1, p0, Lkik/android/widget/dt;->a:I
    ...
    iput-object p1, p0, Lkik/android/widget/dt;->j:Landroid/view/View;

    .line 44
    iget-object p1, p0, Lkik/android/widget/dt;->j:Landroid/view/View;

    new-instance v1, Landroid/view/ViewGroup$LayoutParams;

    iget v3, p0, Lkik/android/widget/dt;->a:I
    ...
    iget-object v0, p0, Lkik/android/widget/dt;->i:Landroid/view/View;
    ...
    iget-object p2, p0, Lkik/android/widget/dt;->j:Landroid/view/View;
...
.method public final a(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    :goto_0
    invoke-static {p1}, Lkik/android/widget/dt;->a(I)I
...
.method public final a(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;FFIZ)V
    ...
    .line 83
    iget-object v1, v8, Lkik/android/widget/dt;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 95
    iget-object v0, v8, Lkik/android/widget/dt;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 102
    iput-object v9, v8, Lkik/android/widget/dt;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    .line 103
    iget-object v1, v8, Lkik/android/widget/dt;->g:Lkik/android/widget/bk;
    ...
    .line 105
    iget-object v0, v8, Lkik/android/widget/dt;->i:Landroid/view/View;

    invoke-virtual {v0, v12}, Landroid/view/View;->setVisibility(I)V

    .line 106
    iget-object v0, v8, Lkik/android/widget/dt;->j:Landroid/view/View;
    ...
    iget v1, v8, Lkik/android/widget/dt;->b:I
    ...
    iget-object v2, v8, Lkik/android/widget/dt;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget v2, v8, Lkik/android/widget/dt;->c:I

    add-int/2addr v1, v2

    .line 114
    iget-object v2, v8, Lkik/android/widget/dt;->i:Landroid/view/View;
    ...
    .line 131
    iput-object v0, v8, Lkik/android/widget/dt;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method public final b(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 62
    iget-object v0, p0, Lkik/android/widget/dt;->g:Lkik/android/widget/bk;
    ...
    invoke-interface {v0, p1, p2}, Lkik/android/widget/bk;->c(II)V
