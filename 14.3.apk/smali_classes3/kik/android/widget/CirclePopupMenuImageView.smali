...
.field private c:Lkik/android/chat/vm/bk;
...
.method private a()V
    ...
    .line 73
    invoke-static {p0}, Lkik/android/widget/r;->a(Lkik/android/widget/CirclePopupMenuImageView;)Landroid/view/View$OnClickListener;
...
.method private a(Lkik/android/chat/vm/bk;)V
    .locals 0
    ...
    .line 110
    iput-object p1, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bk;
...
.method static synthetic a(Lkik/android/widget/CirclePopupMenuImageView;)V
    ...
    .line 75
    iget-object v0, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bk;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bk;

    invoke-interface {v0}, Lkik/android/chat/vm/bk;->ar_()Lrx/d;
    ...
    iget-object v1, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bk;

    invoke-interface {v1}, Lkik/android/chat/vm/bk;->ar_()Lrx/d;

    move-result-object v1

    invoke-static {p0}, Lkik/android/widget/s;->a(Lkik/android/widget/CirclePopupMenuImageView;)Lrx/functions/b;
...
.method public static a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/bk;)V
    .locals 0
    ...
    .line 31
    invoke-direct {p0, p1}, Lkik/android/widget/CirclePopupMenuImageView;->a(Lkik/android/chat/vm/bk;)V

    return-void
.end method

.method static synthetic a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/ei;)V
    .locals 7
    ...
    .line 82
    invoke-virtual {p1}, Lkik/android/chat/vm/ei;->a()Ljava/util/List;
    ...
    invoke-interface {v1}, Lkik/android/chat/vm/bk;->as_()V
    ...
    invoke-static {p0}, Lkik/android/widget/t;->a(Lkik/android/widget/CirclePopupMenuImageView;)Landroid/widget/PopupMenu$OnDismissListener;
    ...
    invoke-static {p1}, Lkik/android/widget/u;->a(Lkik/android/chat/vm/ei;)Landroid/widget/PopupMenu$OnMenuItemClickListener;
    ...
    invoke-static {p1}, Lkik/android/widget/v;->a(Landroid/widget/PopupMenu;)Ljava/lang/Runnable;
...
.method public static a(Lkik/android/widget/CirclePopupMenuImageView;Lkik/android/chat/vm/messaging/ec;)V
    .locals 0
    .annotation build Landroid/databinding/BindingAdapter;
        value = {
            "model"
...
.method static synthetic a(Lkik/android/chat/vm/ei;Landroid/view/MenuItem;)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lkik/android/chat/vm/ei;->a(I)Z
...
.method static synthetic b(Lkik/android/widget/CirclePopupMenuImageView;)V
    ...
    .line 99
    iget-object p0, p0, Lkik/android/widget/CirclePopupMenuImageView;->c:Lkik/android/chat/vm/bk;

    invoke-interface {p0}, Lkik/android/chat/vm/bk;->f()V
