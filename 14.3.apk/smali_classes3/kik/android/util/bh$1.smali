.class final Lkik/android/util/bh$1;
...
.method constructor <init>(Lkik/android/util/bh;)V
    ...
    .line 87
    iput-object p1, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;
...
.method public final synthetic a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->a(Lkik/android/util/bh;)Lcom/kik/android/Mixpanel;

    move-result-object v4

    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->b(Lkik/android/util/bh;)Lkik/core/net/e;

    move-result-object v5

    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->c(Lkik/android/util/bh;)Lkik/core/interfaces/n;

    move-result-object v6

    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->d(Lkik/android/util/bh;)Lkik/core/interfaces/ad;

    move-result-object v7

    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->e(Lkik/android/util/bh;)Lkik/core/interfaces/IConversation;

    move-result-object v8

    iget-object v0, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-static {v0}, Lkik/android/util/bh;->f(Lkik/android/util/bh;)Lkik/core/interfaces/z;
    ...
    .line 1100
    :cond_0
    iget-object p1, p0, Lkik/android/util/bh$1;->a:Lkik/android/util/bh;

    invoke-virtual {p1, p2}, Lkik/android/util/bh;->b(Lkik/core/datatypes/Message;)V
